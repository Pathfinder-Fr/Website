// -----------------------------------------------------------------------
// <copyright file="SueetieBlogBasePage.cs" company="Pathfinder-fr.org">
// Copyright (c) Pathfinder-fr.org. Tous droits reserves.
// </copyright>
// -----------------------------------------------------------------------

namespace Sueetie.Blog.Web.Controls
{
    using System;
    ...
    /// </remarks>
    public class SueetieBlogBasePage : SueetieBasePage
    {
        // Sueetie Modified  - Added Master Page property

        public string SueetieMasterBlogPage { get; set; } = "site.master";

        private int _currentPostContentID = 0;
        ...
        // Sueetie Modified - Using SueetieBasePage custom code and tracking. Optional in future release
        protected virtual void AddBlogCustomCodeToHead()
        {
        ...
        // Sueetie Modified - AddMetaTag() is in SueetieBasePage
        ...
        /// </remarks>
        protected virtual void AddBlogTrackingScript()
        {
            ...
            // Sueetie Modified - Displaying Tracking Script from SueetieBasePage...for now
        ...
        {
            // Sueetie Modified - Moved from OnPreRenderComplete() to accommodate both the displayed title and report log
            if (!this.Page.IsCallback && !this.Page.IsPostBack)
            {
                if (BlogSettings.Instance.UseBlogNameInPageTitles)
                {
                    this.Page.Title = (BlogSettings.Instance.Name + " - " + this.Page.Title);
                }
            }
            base.OnLoad(e);
            ...
            if (!this.Page.IsCallback)
            {
                ...
                // Sueetie Modified - Providing option to load blog-specific custom header code 
                //if (!string.IsNullOrEmpty(BlogSettings.Instance.HtmlHeader))
                //{
                //    this.AddCustomCodeToHead();
                //}

                this.AddBlogTrackingScript();
            }
        ...
        protected override void OnPreInit(EventArgs e)
        {
            ...
            // Sueetie Modified - Changing MasterPageFile

            this.MasterPageFile = string.Format("{0}themes/{1}/{2}", Utils.RelativeWebRoot, this.theme, this.SueetieMasterBlogPage);
