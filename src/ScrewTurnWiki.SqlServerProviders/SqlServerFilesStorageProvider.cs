...
namespace ScrewTurn.Wiki.Plugins.SqlServer
{
    ...
    public class SqlServerFilesStorageProvider : SqlFilesStorageProviderBase
    {
        ...
        public override ComponentInformation Information { get; } =
            new ComponentInformation("SQL Server Files Storage Provider", "Threeplicate Srl", "3.0.1.471",
                "http://www.screwturn.eu", "http://www.screwturn.eu/Version/SQLServerProv/Files.txt");
        ...
        {
            var cmd = GetCommand(connString);
            cmd.CommandText = Resources.FilesDatabase;
