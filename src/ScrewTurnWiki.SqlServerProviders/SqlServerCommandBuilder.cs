...
namespace ScrewTurn.Wiki.Plugins.SqlServer
{
    ...
    public class SqlServerCommandBuilder : ICommandBuilder
    {
        ...
        public IDbCommand GetCommand(string connString, string preparedQuery, List<Parameter> parameters)
        {
        ...
        /// <param name="parameters">The parameters, if any.</param>
        /// <returns>The command.</returns>
        public IDbCommand GetCommand(IDbConnection connection, string preparedQuery, List<Parameter> parameters)
        {
        ...
        /// <param name="parameters">The parameters, if any.</param>
        /// <returns>The command.</returns>
        public IDbCommand GetCommand(IDbTransaction transaction, string preparedQuery, List<Parameter> parameters)
        {
