...
namespace ScrewTurn.Wiki.Plugins.SqlCommon
{
    ...
    public abstract class SqlStorageProviderBase : SqlClassBase
    {
        ...
        protected abstract ICommandBuilder CommandBuilder { get; }
        ...
        /// <summary />
        protected System.Data.SqlClient.SqlConnection OpenDbConnection() => CommandBuilder.GetConnection(connString);
        ...
        /// </summary>
        public abstract ComponentInformation Information { get; }
