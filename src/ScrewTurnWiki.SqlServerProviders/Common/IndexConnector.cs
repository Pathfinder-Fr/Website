...
namespace ScrewTurn.Wiki.Plugins.SqlCommon
{
    ...
    {
        private readonly ClearIndex clearIndex;
        private readonly DeleteDataForDocument deleteData;
        private readonly GetCount getCount;
        private readonly GetSize getSize;
        private readonly GetWordFetcher getWordFetcher;
        private readonly SaveDataForDocument saveData;
        ...
        public int SaveDataForDocument(IDocument document, WordInfo[] content, WordInfo[] title, WordInfo[] keywords,
            object state)
        {
