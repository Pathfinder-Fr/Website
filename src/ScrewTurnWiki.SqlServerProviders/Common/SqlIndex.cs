...
namespace ScrewTurn.Wiki.Plugins.SqlCommon
{
    ...
    {
        private readonly IIndexConnector connector;
        ...
        {
            get { return connector.GetCount(IndexElementType.Words); }
        }
        ...
        {
            get { return connector.GetCount(IndexElementType.Documents); }
        }
        ...
        {
            get { return connector.GetCount(IndexElementType.Occurrences); }
        }
        ...
        public SearchResultCollection Search(SearchParameters parameters)
        {
            ...
            using (var fetcher = connector.GetWordFetcher())
            {
                if (parameters.DocumentTypeTags == null)
                {
                    return SearchEngine.Tools.SearchInternal(parameters.Query, null, false, parameters.Options, fetcher);
                }
                return SearchEngine.Tools.SearchInternal(parameters.Query, parameters.DocumentTypeTags, true,
                    parameters.Options, fetcher);
            }
        }
    }
    ...
    public class SqlWordFetcher : IWordFetcher
    {
        ...
        private readonly TryFindWord implementation;
