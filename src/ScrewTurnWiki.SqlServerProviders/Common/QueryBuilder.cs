...
namespace ScrewTurn.Wiki.Plugins.SqlCommon
{
    ...
    public class QueryBuilder
    {
        ...
        {
            return SelectFrom(table, joinedTable, new[] {tableColumn}, new[] {joinedTableColumn}, join,
        ...
        /// <param name="joinedTableColumns">The joined table columns to select.</param>
        /// <returns>The SELECT query (returned columns are named like <b>[Table_Column]</b>).</returns>
        public string SelectFrom(string table, string joinedTable, string[] joinTableColumns,
            string[] joinJoinedTableColumns, Join join,
            string[] tableColumns, string[] joinedTableColumns)
        {
            ...
            for (var i = 0; i < joinedTableColumns.Length; i++)
            {
                sb.Append(builder.ObjectNamePrefix);
            ...
            string otherJoinedTable, string otherJoinedTableColumn, Join otherJoin, string[] otherJoinedTableColumns)
        {
            ...
            for (var i = 0; i < otherJoinedTableColumns.Length; i++)
            {
                sb.Append(builder.ObjectNamePrefix);
        ...
        /// <returns>The resulting query.</returns>
        public string Where(string query, string column, WhereOperator op, string parameter, bool openBracket,
            bool closeBracket)
        {
        ...
        /// <param name="closeBracket">A value indicating whether to close a bracket after the clause.</param>
        /// <returns>The resulting query.</returns>
        public string AndWhere(string query, string column, WhereOperator op, string parameter, bool openBracket,
            bool closeBracket)
        {
        ...
        /// <param name="closeBracket">A value indicating whether to close a bracket after the clause.</param>
        /// <returns>The resulting query.</returns>
        public string OrWhere(string query, string column, WhereOperator op, string parameter, bool openBracket,
            bool closeBracket)
        {
