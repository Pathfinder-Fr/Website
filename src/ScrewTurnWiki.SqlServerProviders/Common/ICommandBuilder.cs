...
namespace ScrewTurn.Wiki.Plugins.SqlCommon
{
    ...
    public interface ICommandBuilder
    {
        ...
        SqlConnection GetConnection(string connString);
        ...
        IDbCommand GetCommand(string connString, string preparedQuery, List<Parameter> parameters);
        ...
        /// <param name="parameters">The parameters, if any.</param>
        /// <returns>The command.</returns>
        IDbCommand GetCommand(IDbConnection connection, string preparedQuery, List<Parameter> parameters);
        ...
        /// <param name="parameters">The parameters, if any.</param>
        /// <returns>The command.</returns>
        IDbCommand GetCommand(IDbTransaction transaction, string preparedQuery, List<Parameter> parameters);
    }
}