...
namespace GalleryServerPro.Web.Controls
{
	public partial class login : GalleryUserControl
	{
		...
		{
			Controller.UserController.UserLoggedOn(Login1.UserName, this.GalleryPage.GalleryId);

			if (this.GalleryPage.GallerySettings.EnableUserAlbum && this.GalleryPage.GallerySettings.RedirectToUserAlbumAfterLogin)
			{
				Util.Redirect(Util.GetUrl(PageId.album, "aid={0}", Controller.UserController.GetUserAlbumId(Login1.UserName, this.GalleryPage.GalleryId)));
			}
