...
<ComponentArt:Menu ID="Menu1" CssClass="gsp_mnu0TopGroup" DefaultGroupCssClass="gsp_mnu0MenuGroup"
	...
	<Items>
		<ComponentArt:MenuItem ID="mnuAction" runat="server" LookId="TopItemLook" ChildSelectedLook-LeftIconVisibility="Always"
			...
			<ComponentArt:MenuItem LookId="BreakItem" /> 
            <%--  // Sueetie Modified - Added Include In Download Menu Item --%>
            <ComponentArt:MenuItem ID="mnuIncludeInDownload" runat="server" Look-LeftIconUrl="addobject.png" />
            <ComponentArt:MenuItem ID="mnuEditSueetieCaptions" runat="server" Look-LeftIconUrl="copyobjects.png" />
            <ComponentArt:MenuItem ID="mnuEditSueetieAlbums" runat="server" Look-LeftIconUrl="copyobjects.png" />
			<ComponentArt:MenuItem LookId="BreakItem" />
