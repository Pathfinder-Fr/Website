<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="albumedittemplate.ascx.cs" Inherits="GalleryServerPro.Web.Controls.albumedittemplate" %>
...
<table class='gsp_standardTable gsp_addpadding1' onkeypress="javascript:return WebForm_FireDefaultButton(event, 'btnSave')">
	<tr>
		...
		<td>
			<asp:TextBox ID="txtTitle" runat="server" CssClass="gsp_textbox" Text="1" />
			...
			<cc1:ValidatorCalloutExtender runat="server" ID="rfv1E" TargetControlID="rfv1" HighlightCssClass="gsp_validatorCalloutHighlight" />
		</td>
	...
	<tr>
		<td class='gsp_bold gsp_nowrap gsp_aligntop gsp_col1'>
			<p style="padding-top:2px;"><asp:Literal ID="l2" runat="server" Text="<%$ Resources:GalleryServerPro, UC_Album_Header_Edit_Album_Owner_Header_Text %>" /></p>
		</td>
		<td colspan="2">
        ...
        DropDownPageSize="100"
				ItemCssClass="gsp_ddn-item"
				ItemHoverCssClass="gsp_ddn-item-hover"
				CssClass="gsp_cmb"
				TextBoxCssClass="gsp_txt"
				DropDownResizingMode="Corner"
				DropDownCssClass="gsp_ns gsp_ddn"
				DropDownContentCssClass="gsp_ddn-con"
				SelectedItemCssClass="gsp_ddn-item-hover" 
			>
				<DropDownFooter><div style="text-align:right;"><img src="<%= Util.GetUrl("/images/componentart/combobox/bottom_right.gif") %>" alt="" /></div></DropDownFooter>
			</ComponentArt:ComboBox>
		</asp:View>
		<asp:View ID="vwOwnerReadOnly" runat="server">
			<p class="gsp_msgfriendly"><asp:Literal ID="litOwnerReadOnly" runat="server" /></p>
		</asp:View>
		</asp:MultiView>
		<asp:Panel ID="pnlInheritedOwner" runat="server" Visible="false">
			<p class="gsp_em"><asp:Literal ID="l5" runat="server" Text="<%$ Resources:GalleryServerPro, UC_Album_Header_Edit_Album_Inherited_Owner_Label %>" />&nbsp;<asp:Literal ID="litInheritedOwner" runat="server" /></p>
		</asp:Panel>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
			<img src="<%= Util.GalleryRoot %>/images/lock_24x24.png" style="width: 24px; height: 24px;
				vertical-align: bottom;" alt="" /><input id="private" type="checkbox" /><label for="private"><asp:Literal ID="l6" runat="server" Text="<%$ Resources:GalleryServerPro, UC_Album_Header_Edit_Album_Is_Private_Text %>" /></label>
