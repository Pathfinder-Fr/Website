...
<div class="gsp_navigation">
    <ComponentArt:NavBar ID="nbAdminMenu" runat="server" Visible="false" Height="500px"
        Width="200px" ExpandSinglePath="false" CssClass="nb0NavBar" DefaultItemLookId="TopItemLook"
        ...
        <Items>
            <ComponentArt:NavBarItem ID="nbiSiteSettings" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_Site_Settings_Hdr_Text %>"
                SubGroupCssClass="nb0Level2Group" DefaultSubItemLookId="Level2ItemLook" SelectedLookId="TopItemLook"
                Expanded="true" Selectable="false">
            ...
            <ComponentArt:NavBarItem ID="nbiGallerySettings" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_Gallery_Settings_Hdr_Text %>"
                SubGroupCssClass="nb0Level2Group" DefaultSubItemLookId="Level2ItemLook" SelectedLookId="TopItemLook"
                Expanded="true" Selectable="false">
            ...
            <ComponentArt:NavBarItem ID="nbiMembership" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_Membership_Hdr_Text %>"
                SubGroupCssClass="nb0Level2Group" DefaultSubItemLookId="Level2ItemLook" SelectedLookId="TopItemLook"
                Expanded="true" Selectable="false">
            ...
            <ComponentArt:NavBarItem ID="nbiAlbums" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_Albums_Hdr_Text %>"
                SubGroupCssClass="nb0Level2Group" DefaultSubItemLookId="Level2ItemLook" SelectedLookId="TopItemLook"
                Expanded="true" Selectable="false">
                <ComponentArt:NavBarItem ID="nbiAlbumsGeneral" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_Albums_General_Link_Text %>" />
            </ComponentArt:NavBarItem>
            <ComponentArt:NavBarItem ID="nbiMediaObjects" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_Media_Objects_Hdr_Text %>"
                SubGroupCssClass="nb0Level2Group" DefaultSubItemLookId="Level2ItemLook" SelectedLookId="TopItemLook"
                Expanded="true" Selectable="false">
            ...
            <ComponentArt:NavBarItem ID="NavBarItem11" runat="server" Text="<%$ Resources:Sueetie, Admin_Sueetie_Hdr_Text %>"
                SubGroupCssClass="nb0Level2Group" DefaultSubItemLookId="Level2ItemLook" SelectedLookId="TopItemLook"
                Expanded="true" Selectable="false">
                <ComponentArt:NavBarItem ID="nbiSueetieObjects" runat="server" Text="<%$ Resources:Sueetie, Admin_Media_Sueetie_Content_Link_Text %>" />
                <ComponentArt:NavBarItem ID="nbiSueetieAlbumPaths" runat="server" Text="<%$ Resources:Sueetie, Admin_Media_Sueetie_AlbumPaths_Link_Text %>" />
            </ComponentArt:NavBarItem>
        </Items>
    </ComponentArt:NavBar>
</div>
