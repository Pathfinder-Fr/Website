...
namespace GalleryServerPro.Web.Controls
{
	public partial class pager : GalleryUserControl
	{
		...
		private void CreatePagingControls()
		{
			...
			hlPrevious.Text = Resources.GalleryServerPro.UC_Pager_Previous_Text;
			hlPrevious.ToolTip = Resources.GalleryServerPro.UC_Pager_Previous_Tooltip;
			hlPrevious.NavigateUrl = "javascript:goPage('" + (CurrentPage - 1) + "');";
			...
			for (i = 1; i <= DataSource.DataSourceCount / PageSize; i++)
			{
				...
				else
				{
					...
					hl.Text = i.ToString();
					hl.NavigateUrl = "javascript:goPage('" + i + "');";
			...
			hlNext.Text = Resources.GalleryServerPro.UC_Pager_Next_Text;
			hlNext.ToolTip = Resources.GalleryServerPro.UC_Pager_Next_Tooltip;
			hlNext.NavigateUrl = "javascript:goPage('" + (CurrentPage + 1) + "');";
