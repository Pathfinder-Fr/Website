...
<asp:Panel ID="pnlAlbumHeader" runat="server">
	<div class="gsp_albumdetail">
		...
		<p id="pADC" runat="server" class="gsp_useroption gsp_downloadzip"><a href='<%= Util.GetUrl(PageId.task_downloadobjects, "aid={0}", GalleryPage.GetAlbumId()) %>' class=""><img src="<%= Util.GalleryRoot %>/images/downloadzip.png" style="width:32px;height:32px;" alt='<asp:Literal
	...
	<p class="gsp_h1">
		...
		<img id="albumPrivateIcon" src="<%= Util.GalleryRoot %>/images/lock_24x24.png" style="width: 24px;
