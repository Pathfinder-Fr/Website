<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="recoverpassword.ascx.cs" Inherits="GalleryServerPro.Web.Pages.recoverpassword" %>
...
<asp:Panel ID="pnlPwdRecoverContainer" runat="server" CssClass="pwdrecover gsp_rounded10" DefaultButton="btnRetrievePassword">
	...
	<p>
		...
		<asp:RequiredFieldValidator ID="rfv1" runat="server" ControlToValidate="txtUserName"
			Display="Dynamic" ErrorMessage="<%$ Resources:GalleryServerPro, Anon_Pwd_Recovery_Username_Required_Text %>">
