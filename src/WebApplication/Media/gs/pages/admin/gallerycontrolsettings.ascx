...
<div id="d1" runat="server">
	<script type="text/javascript">
		...
		function gsp_configViewModeControls()
		{
			...
			$('#<%= txtTreeviewNavigateUrl.ClientID %>').attr('disabled', (!rbViewModeTreeview.attr('checked') || rbViewModeTreeview.attr('disabled')));
		}
		...
		function gsp_configDefaultGalleryObjectControls()
		{
			...
			if (!rbDefaultAlbum.attr('checked') || rbDefaultAlbum.attr('disabled'))
				cboDefaultAlbum.disable();
			else
				cboDefaultAlbum.enable();

			$('#<%= txtDefaultMediaObjectId.ClientID %>').attr('disabled', (!rbDefaultMediaObject.attr('checked') || rbDefaultMediaObject.attr('disabled')));
		}
		...
		function gsp_configOverridableControls()
		{
			...
			var chkShowMediaObjectToolbar = $('#<%= chkShowMediaObjectToolbar.ClientID %>');

			var isOverrideInactive = (!chkOverride.attr('checked') || chkOverride.attr('disabled'));

			$('#<%= chkShowAlbumTreeViewForAlbum.ClientID %>').attr('disabled', isOverrideInactive);
			$('#<%= chkShowAlbumTreeViewForMO.ClientID %>').attr('disabled', isOverrideInactive);

			chkShowHeader.attr('disabled', isOverrideInactive);

			gsp_configShowHeaderControls();

			$('#<%= chkAllowAnonBrowsing.ClientID %>').attr('disabled', isOverrideInactive);
			$('#<%= chkShowActionMenu.ClientID %>').attr('disabled', isOverrideInactive);
			$('#<%= chkShowAlbumBreadcrumb.ClientID %>').attr('disabled', isOverrideInactive);
			$('#<%= chkShowMediaObjectNavigation.ClientID %>').attr('disabled', isOverrideInactive);
			$('#<%= chkShowMediaObjectIndexPosition.ClientID %>').attr('disabled', isOverrideInactive);
			$('#<%= chkShowMediaObjectTitle.ClientID %>').attr('disabled', isOverrideInactive);
			$('#<%= chkAutoPlaySlideshow.ClientID %>').attr('disabled', isOverrideInactive);
			$('#<%= chkShowMediaObjectToolbar.ClientID %>').attr('disabled', isOverrideInactive);
		...
		{
			var chkShowHeader = $('#<%= chkShowHeader.ClientID %>');
			var isShowHeaderInactive = (!chkShowHeader.attr('checked') || chkShowHeader.attr('disabled'));

			$('#<%= txtGalleryTitle.ClientID %>').attr('disabled', isShowHeaderInactive);
			$('#<%= txtGalleryTitleUrl.ClientID %>').attr('disabled', isShowHeaderInactive);
			$('#<%= chkShowLogin.ClientID %>').attr('disabled', isShowHeaderInactive);
			$('#<%= chkShowSearch.ClientID %>').attr('disabled', isShowHeaderInactive);
		}

		function gsp_configToolbarControls()
		{
			var chkShowToolbar = $('#<%= chkShowMediaObjectToolbar.ClientID %>');
			var isShowToolbarInactive = (!chkShowToolbar.attr('checked') || chkShowToolbar.attr('disabled'));

			$('#<%= chkShowMetadataButton.ClientID %>').attr('disabled', isShowToolbarInactive);
			$('#<%= chkShowDownloadButton.ClientID %>').attr('disabled', isShowToolbarInactive);
			$('#<%= chkShowDownloadZipButton.ClientID %>').attr('disabled', isShowToolbarInactive);
			$('#<%= chkShowHighResButton.ClientID %>').attr('disabled', isShowToolbarInactive);
			$('#<%= chkShowPermalinkButton.ClientID %>').attr('disabled', isShowToolbarInactive);
			$('#<%= chkShowSlideShowButton.ClientID %>').attr('disabled', isShowToolbarInactive);
			$('#<%= chkShowMoveButton.ClientID %>').attr('disabled', isShowToolbarInactive);
			$('#<%= chkShowCopyButton.ClientID %>').attr('disabled', isShowToolbarInactive);
			$('#<%= chkShowRotateButton.ClientID %>').attr('disabled', isShowToolbarInactive);
			$('#<%= chkShowDeleteButton.ClientID %>').attr('disabled', isShowToolbarInactive);
		}

		function gsp_handleAlbumComboBoxSelection(sender, e)
		{
			$('#<%= rbDefaultAlbum.ClientID %>').attr('checked', true);
