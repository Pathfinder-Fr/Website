...
<div id="d1" runat="server">
	...
	<script type="text/javascript">
		...
		function configControls()
		{
			...
			$('#<%= chkExtractMetadataUsingWpf.ClientID %>').attr('disabled', (!chkExtractMetadata.attr('checked') || chkExtractMetadata.attr('disabled')));
			...
			var enableMetadata = (chkEnableMetadata.attr('checked') && !chkEnableMetadata.attr('disabled'));
			if (enableMetadata)
			{
				enableMetadataList();
			}
		...
		function enableMetadataList()
		{
			...
			$("#gsp_MetadataPropertiesContainer li input:checkbox").attr('disabled', false);
		}
		...
		function disableMetadataList()
		{
			...
			$("#gsp_MetadataPropertiesContainer li input:checkbox").attr('disabled', true);
		}
