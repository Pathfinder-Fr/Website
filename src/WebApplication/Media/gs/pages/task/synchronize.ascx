	...
	<ComponentArt:Dialog ID="dgSynch" runat="server" Title="<%$ Resources:GalleryServerPro, Task_Synch_Progress_Title_Text %>"
		...
		<HeaderTemplate>
			<div onmousedown="dgSynch.StartDrag(event);">
				<img id="dg0DialogIconImage" src="<%= Util.GalleryRoot %>/images/componentart/dialog/pencil.gif"
					alt="" />
		...
		<ContentTemplate>
			<div class="gsp_addpadding1">
				...
				<img id="synchAnimation" src="<%= Util.GalleryRoot %>/images/synch.gif" alt="" style="display: block;
