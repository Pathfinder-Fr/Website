	...
	public partial class rotateimage : Pages.TaskPage
	{
		...
		protected override bool OnBubbleEvent(object source, EventArgs args)
		{
			...
			if ((btn != null) && (((btn.ID == "btnOkTop") || (btn.ID == "btnOkBottom"))))
			{
				...
				if (msg > int.MinValue)
					Util.Redirect(PageId.mediaobject, "moid={0}&msg={1}", this.GetMediaObjectId(), msg.ToString(CultureInfo.InvariantCulture));
				else
					Util.Redirect(PageId.mediaobject, "moid={0}&msg={1}", this.GetMediaObjectId(), ((int)Message.ObjectsSuccessfullyRotated).ToString(CultureInfo.InvariantCulture));}
