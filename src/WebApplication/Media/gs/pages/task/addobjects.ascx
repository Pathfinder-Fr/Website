		...
		<script type="text/javascript">
			...
			function format_time(t, txt)
			{
				...
				} else
				{
					...
					if (m !== "" && out == "")
					{ //	shorter than an hour, greater than 60 seconds
						out += m;
						if (s != "") out += ", " + s; //	at least one second
					}
			...
			(new Image()).src = "<%= Util.GalleryRoot %>/images/componentart/upload/vertical.png";
			(new Image()).src = "<%= Util.GalleryRoot %>/images/spinner.gif";
		...
		<ComponentArt:MultiPage ID="mpAddObjects" CssClass="mp2MultiPage" runat="server">
			<ComponentArt:PageView ID="pvAddLocal" CssClass="mp2MultiPageContent" runat="server">
				...
				<div class="gsp_addleftpadding1 gsp_addtopmargin5">
					...
					<asp:Panel ID="pnlOptions" runat="server" Style="overflow: hidden; height: 0;">
						<p class="gsp_fs">
				...
				<div class="gsp_rightBottom" style="margin-top: 1em;">
					...
					<asp:Button ID="btnCancelLocal" runat="server" OnClientClick="ClearFiles()"
						OnClick="btnCancel_Click" CausesValidation="false" Text="<%$ Resources:GalleryServerPro, Default_Task_Cancel_Button_Text %>"
					...
					<tr>
						...
						<td>
							...
							<asp:RequiredFieldValidator ID="rfv1" runat="server" Enabled="false" ControlToValidate="txtExternalHtmlSource"
								Display="None" ErrorMessage="<%$ Resources:GalleryServerPro, Task_Add_Objects_External_Embed_Code_Missing_Text %>" />
...
<cc1:CollapsiblePanelExtender ID="cpe" runat="Server" TargetControlID="pnlOptions"
	...
	ExpandDirection="Vertical" TextLabelID="lblExpCol" ExpandedText="<%$ Resources:GalleryServerPro, Task_Add_Objects_ExpandedText_Label %>"
	CollapsedText="<%$ Resources:GalleryServerPro, Task_Add_Objects_CollapsedText_Label %>" />
