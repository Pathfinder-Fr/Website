...
namespace GalleryServerPro.Web.Pages.Task
{
	public partial class addobjects : Pages.TaskPage
	{
		...
		{
			tsAddObjects.ImagesBaseUrl = String.Concat(Util.GalleryRoot, "/images/componentart/tabstrip/");
			tsAddObjects.TopGroupSeparatorImagesFolderUrl = String.Concat(Util.GalleryRoot, "/images/componentart/tabstrip/");
...
",
		...
		private bool AddExternalHtmlContent()
		{
			...
			mediaObject.Title = Util.CleanHtmlTags(title, GalleryId);
