<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="createalbum.ascx.cs"	Inherits="GalleryServerPro.Web.Pages.Task.createalbum" %>
...
<div class="gsp_content">
	...
	<p>
        ...
        <p>
        <%-- // Sueetie Modified - Add Album Type ------------------------------------%>
        Content Type:
        <asp:DropDownList ID="ddSueetieAlbumType" runat="server" />
    </p>
