...
{
	/// <summary>
	/// The base class user control used in Gallery Server Pro to represent a task page, such as adding objects and
	/// deleting albums.
	/// </summary>
	public class TaskPage : Pages.GalleryPage
	{
		...
		/// <summary>
		/// Gets or sets the location for the <see cref="GalleryServerPro.Web.Controls.Task.taskheader"/> user control. Classes that inherit 
		...
		/// </summary>
		/// <value>The <see cref="GalleryServerPro.Web.Controls.Task.taskheader"/> user control.</value>
		...
		/// page title and the top Save/Cancel buttons. (The bottom Save/Cancel buttons are in the <see cref="GalleryServerPro.Web.Controls.Task.taskfooter"/> user control.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the location for the <see cref="GalleryServerPro.Web.Controls.Task.taskfooter"/> user control. Classes that inherit 
		/// <see cref="Pages.TaskPage"/> should set this property to the <see cref="PlaceHolder"/> that is to contain
		/// the task footer control. If this property is not assigned by the inheriting class, the task footer control
		/// is not added to the page output.
		/// </summary>
		/// <value>The <see cref="GalleryServerPro.Web.Controls.Task.taskfooter"/> user control.</value>
		...
		{
			Controls.Task.taskheader taskHeader = (Controls.Task.taskheader)LoadControl(Util.GetUrl("/controls/task/taskheader.ascx"));
			this.TaskHeader = taskHeader;
			if (this.TaskHeaderPlaceHolder != null)
				this.TaskHeaderPlaceHolder.Controls.Add(taskHeader);

			Controls.Task.taskfooter taskFooter = (Controls.Task.taskfooter)LoadControl(Util.GetUrl("/controls/task/taskfooter.ascx"));
