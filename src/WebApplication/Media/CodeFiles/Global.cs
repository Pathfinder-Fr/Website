namespace GalleryServerPro.Web
{
	...
	public enum PageId
	{
		...
		search,
        upgrade,
        // Sueetie Modified - Added Pages
        task_editsueetiecaptions,
        task_editsueetiealbums,
        admin_sueetiecontent,
        task_includeindownload,
        admin_sueetiealbumpaths
	}
	...
	public enum Message
	{
        ...
        // Sueetie Modified - Added No Media Objects to Include in Download Report
        CannotIncludeObjectsNoObjectsExistInAlbum = 1001,
        ObjectsSuccessfullyIncluded = 1002
	}
