<%@ Page Language="C#" Inherits="Sueetie.Commerce.Pages.MarketplaceDefaultPage"
    Title="Sueetie Marketplace - Home Page" MasterPageFile="~/Themes/Lollipop/Masters/marketplace.master" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="cphBody" runat="server">
    <div id="body">
        <h3 class="section">
            <a href="default.aspx">Categories</a>
            <SUEETIE:CommerceBreadCrumbs ID="CommerceBreadCrumbs1" runat="server" />
        </h3>
