                    ...
                    <asp:PasswordRecovery ID="PasswordRecovery1" runat="server" OnSendingMail="PasswordRecovery1_SendingMail" >
                        ...
                        <UserNameTemplate>
                            <div class="ForgetPasswordArea">
                                <p>
                                <SUEETIE:SueetieLocal ID="SueetieLocal1" runat="server" Key="forgot_password_enterusername" />
                                    
                                </p>
                                <p>
                                    <asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="UserName" CssClass="LoginBoxBig"
                                        Width="220" Text="Username" /></p>
                                <p> 
                                    <asp:TextBox ID="UserName" runat="server" CssClass="LoginBoxBig" Width="220"></asp:TextBox>
                                ...
                                <div class="TextButtonBigArea">
                                    ...
                                    <asp:Button ID="SendEmailButton" CommandName="Submit" runat="server" Text="Send"
                                        CssClass="TextButtonBig" ValidationGroup="PasswordRecovery1" />
                                </div>
                                <div class="LoginFailureMessageArea">
                                    <asp:Literal ID="FailureText" runat="server" EnableViewState="False"></asp:Literal>
                                </div>
                                <div class="LoginFailureMessageArea">
                                    <a href="ForgotUsername.aspx">
                                    <SUEETIE:SueetieLocal ID="SueetieLocal2" runat="server" Key="forgot_username_question" />
                                    </a>
                                </div>
                                <div style="height: 25px;">
                                </div>
