...
<div id="ViewItem" class="WikiViewItem">
  ...
  <div class="ViewItemAuthorDate">Par <a href="/members/profile.aspx?u=<%= WikiPage.UserID %>"><%= WikiPage.DisplayName%></a> le <%= WikiPage.DateTimeModified.ToLongDateString()%></div>
</div>