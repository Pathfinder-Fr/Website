...
<asp:Content ContentPlaceHolderID="cphBody" runat="server">
    ...
    <script language="JavaScript">
        ...
        function SetUsernameStatusMessage(result) {
            if (!result) {
                $("#UsernameCheckMsg").html("<br />Ce nom d'utilisateur est déjà pris. <a href='ForgotPassword.aspx'>Vous avez perdu vos identifiants ?</a>");
            } else
        ...
        function SetEmailStatusMessage(result) {
            if (!result) {
                $("#EmailCheckMsg").html("<br />Cette adresse email est déjà utilisée. <a href='ForgotPassword.aspx'>vous avez perdu vos identifiants ?</a>");
            } else
                $("#EmailCheckMsg").html("");
        }
        ...
        function SetDisplayNameStatusMessage(result) {
            if (!result) {
                $("#DisplayNameCheckMsg").html("<br />Ce nom d'affichage est déjà pris. Veuillez en choisir un autre.");
            } else
                    ...
                    <div class="JoinArea">
                        <table cellpadding="0" cellspacing="4" border="0" width="650px">
                            ...
                            <tr class="password">
                                ...
                                <td>
                                    <asp:TextBox ID="txtPassword1" textmode="password" runat="server" CssClass="LoginBoxBig" />
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionEmailValidator" ControlToValidate="txtEmailAddress"
                                        Display="Dynamic" ValidationExpression="^[a-zA-Z][\w\.\-_\+]*[a-zA-Z0-9_]@[a-zA-Z0-9][\w\.-]*[a-zA-Z0-9]\.[a-zA-Z][a-zA-Z\.]*[a-zA-Z]$"
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionDisplayNameValidator" ControlToValidate="txtDisplayName"
                                        Display="Dynamic" ValidationExpression="^[a-zA-Z \.\-\'0-9]{2,25}" runat="Server"
