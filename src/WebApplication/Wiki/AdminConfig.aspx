...
<asp:Content ID="ctnConfig" ContentPlaceHolderID="cphAdmin" runat="server">
	...
	<div id="ConfigContentDiv">
		...
		<div class="featurecontainer">
			<anthem:CheckBox ID="chkIgnoreSingleSquareBrackets" runat="server" 
				Text="Ignore links wrapped by only singles square brackets" 
				meta:resourcekey="chkIgnoreSingleSquareBrackets" />
		</div>
