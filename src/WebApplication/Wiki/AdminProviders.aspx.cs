...
namespace ScrewTurn.Wiki {
	...
	public partial class AdminProviders : BasePage {
		...
		protected void rptProviders_DataBinding(object sender, EventArgs e) {
			...
			if(rdoPages.Checked) {
				enabledCount = Collectors.PagesProviderCollector.AllProviders.Count;
				...
				enabledCount = Collectors.UsersProviderCollector.AllProviders.Count;
				...
				enabledCount = Collectors.FilesProviderCollector.AllProviders.Count;
				...
				enabledCount = Collectors.CacheProviderCollector.AllProviders.Count;
				...
				enabledCount = Collectors.FormatterProviderCollector.AllProviders.Count;
