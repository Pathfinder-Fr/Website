...
namespace ScrewTurn.Wiki
{
    ...
    public static class LoginTools
    {
        ...
        public static void TryAutoLogin()
        {
            ...
            {
                var username = HttpContext.Current.Request.Cookies[Settings.LoginCookieName].Values[Username];
                var key = HttpContext.Current.Request.Cookies[Settings.LoginCookieName].Values[LoginKey];
            ...
            else if (SessionFacade.LoginKey == null && HttpContext.Current.Session[Logout] == null)
            { // Check for filtered autologin
        ...
        public static void TryRedirect(bool goHome)
        {
            ...
            {
                var target = HttpContext.Current.Request["Redirect"];
        ...
        {
            var cookie = new HttpCookie(Settings.LoginCookieName);
