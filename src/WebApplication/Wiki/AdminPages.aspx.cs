    ...
    public partial class AdminPages : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                var loaded = LoadExternallySelectedPage();
        ...
        private void AutoRollback()
        {
            ...
            if (backups.Count > 0)
            {
                var targetRevision = backups[backups.Count - 1];
        ...
        protected void btnNewPage_Click(object sender, EventArgs e)
        {
            ...
            var currentNamespace = lstNamespace.SelectedValue;
        ...
        {
            var r = permissionsManager.CurrentResourceName;
        ...
        private bool PopulateTargetNamespaces(PageInfo page)
        {
            ...
            if (pageNamespace != null)
            {
                ...
                var canManagePages = AuthChecker.CheckActionForNamespace(null, Actions.ForNamespaces.ManagePages, currentUser, currentGroups);
            ...
            foreach (NamespaceInfo nspace in Pages.GetNamespaces().FindAll(n => n.Provider == page.Provider))
            {
                ...
                {
                    var canManagePages = AuthChecker.CheckActionForNamespace(nspace, Actions.ForNamespaces.ManagePages, currentUser, currentGroups);
        ...
        private void ActivatePageEditor()
        {
            ...
            var canApproveReject = AdminMaster.CanApproveDraft(page, currentUser, currentGroups);
            var canDeletePages = AuthChecker.CheckActionForNamespace(nspace, Actions.ForNamespaces.DeletePages, currentUser, currentGroups);
            var canManageAllPages = AuthChecker.CheckActionForNamespace(nspace, Actions.ForNamespaces.ManagePages, currentUser, currentGroups);
            var canManagePage = AuthChecker.CheckActionForPage(page, Actions.ForPages.ManagePage, currentUser, currentGroups);
            var canManageDiscussion = AuthChecker.CheckActionForPage(page, Actions.ForPages.ManageDiscussion, currentUser, currentGroups);
            var namespaceAvailable = PopulateTargetNamespaces(page);
            ...
            var currentDefaultPage = currentNamespace != null ? currentNamespace.DefaultPage.FullName : Settings.DefaultPage;
        ...
        private void LoadBackups(string pageName)
        {
            ...
            foreach (var bak in backups)
            {
                ...
                var item = new ListItem(bak.ToString() + ": " +
        ...
        protected void btnApprove_Click(object sender, EventArgs e)
        {
            ...
            var done = Pages.ModifyPage(draft.PageInfo, draft.Title, draft.User, draft.LastModified, draft.Comment,
        ...
        protected void btnRename_Click(object sender, EventArgs e)
        {
            ...
            var currentNamespace = NameTools.GetNamespace(txtCurrentPage.Value);
            var currentPage = NameTools.GetLocalName(txtCurrentPage.Value);
            ...
            var done = Pages.RenamePage(oldPage, txtNewName.Text);
        ...
        protected void btnRollback_Click(object sender, EventArgs e)
        {
            ...
            var done = Pages.Rollback(page, targetRevision);
        ...
        protected void btnClearDiscussion_Click(object sender, EventArgs e)
        {
            ...
            var done = Pages.RemoveAllMessages(page);
        ...
        protected void btnDeletePage_Click(object sender, EventArgs e)
        {
            ...
            var done = Pages.DeletePage(page);
        ...
        protected void btnBulkMigratePages_Click(object sender, EventArgs e)
        {
            ...
            var selectedPages = new List<PageInfo>(20);
            foreach (var pg in pageListBuilder.SelectedPages)
            {
            ...
            var nspaceName = lstBulkMigrateTargetNamespace.SelectedValue;
