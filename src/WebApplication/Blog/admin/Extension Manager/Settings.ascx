<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="~/admin/Extension Manager/Settings.ascx.cs" Inherits="BlogEngine.Admin.ExtensionManager.UserControlsXmanagerParameters" %>
