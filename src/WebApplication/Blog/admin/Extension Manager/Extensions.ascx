<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="~/admin/Extension Manager/Extensions.ascx.cs" Inherits="BlogEngine.Admin.ExtensionManager.UserControlsXmanagerExtensionsList" %>
