<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="~/admin/Extension Manager/Editor.ascx.cs" Inherits="BlogEngine.Admin.ExtensionManager.UserControlsXmanagerSourceEditor" %>
