...
public partial class _default : SueetieBlogBasePage
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        {
            if (Request.QueryString.Count == 0 || !string.IsNullOrEmpty(Request.QueryString["page"]) || !string.IsNullOrEmpty(Request.QueryString["theme"]) || !string.IsNullOrEmpty(Request.QueryString["blog"]))
            {
            ...
            {
                Page.Title += "All posts tagged '" + Request.QueryString["tag"].Substring(1) + "'";
            }
        }
    }
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		else if (Request.QueryString.Count == 0 || !string.IsNullOrEmpty(Request.QueryString["page"]) || !string.IsNullOrEmpty(Request.QueryString["theme"]) || !string.IsNullOrEmpty(Request.QueryString["blog"]))
		{
            ...
            // Sueetie Modified - Moved Page Title to Page_Init()
