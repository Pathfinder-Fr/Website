...
{
    public partial class Contact : SueetieBlogBasePage, ICallbackEventHandler
    {

        // Sueetie Modified - Setting master page and page title

        protected override void OnPreInit(EventArgs e)
        {
            this.SueetieMasterBlogPage = "contact.master";
            base.OnPreInit(e);
        }
