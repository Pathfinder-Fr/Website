namespace UserControls
{
    ...
    public partial class PostList : UserControl
    {
        ...
        private void BindPosts()
        {
            ...
            // Sueetie Modified - Using ListPostView.ascx
            var path = string.Format("{0}themes/{1}/ListPostView.ascx", Utils.RelativeWebRoot, theme);
            var counter = 0;
        ...
        private void InitPaging()
        {
            ...
            {
                ((SueetieBlogBasePage)this.Page).AddGenericLink("next", "Next page", this.hlNext.HRef);
            }

            if (this.hlPrev.Visible)
            {
                ((SueetieBlogBasePage)this.Page).AddGenericLink("prev", "Previous page", string.Format(url, page + 2));
            }
        }
