<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CommentView.ascx.cs" Inherits="BlogEngine.UserControls.CommentView" %>
...
<asp:PlaceHolder runat="server" ID="phPleaseLogin">
    <div class="PleaseLogin">
        <a href="/members/login.aspx?ReturnUrl=<%= Request.RawUrl %>#comment">Please login</a> to leave a comment.
    </div>
</asp:PlaceHolder>
