// -----------------------------------------------------------------------
// <copyright file="login.aspx.cs" company="Pathfinder-fr.org">
...
namespace BlogEngine.Account
{
    ...
    public partial class Login : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ((PlaceHolder)this.LoginUser.FindControl("phResetPassword")).Visible = BlogSettings.Instance.EnablePasswordReset;
