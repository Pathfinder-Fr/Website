...
namespace BlogEngine.Controls
{
	...
	public class MonthList : Control
	{
		...
		/// <summary>
		/// Specifies the way <see cref="BlogEngine.Controls.MonthList" /> control is displayed.
		/// </summary>
		[Flags]
		public enum MonthListDisplayOptions
		{
			/// <summary>
			/// A convenience constant that corresponds to default <see cref="BlogEngine.Controls.MonthList" />
			/// behavior where grouping by year is performed.
			/// </summary>
			Grouping_ByYear = 0,

			/// <summary>
			/// When set, the <see cref="BlogEngine.Controls.MonthList" /> control renders
			...
			/// <summary>
			/// When set, the the <see cref="BlogEngine.Controls.MonthList" /> control renders
