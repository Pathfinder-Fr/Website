<%@ Page Language="C#" AutoEventWireup="true" Inherits="Sueetie.Analytics.Pages.ViewsForMemberPage"
        ...
        <div class="AnalyticsReportPages">
            <div class="AdminTextTalk">
                <div class="ReportTitleSelectArea">
                    <div class="Title">
                        Analytics Page Activity Report - Selected Member</div>
                ...
                <div class="HeaderBox">
                    <strong><a href='<%= ProfileUrl %>' target='_blank'>
                        <%= DisplayName %></a></strong>. Time Period: <strong>
            ...
            <table border="1" id="PageTable" class="AgentsTable">
                ...
                <asp:Repeater ID="rptIpLog" runat="server" EnableViewState="false" OnItemDataBound="rptIpLog_OnItemDataBound">
                    <ItemTemplate>
                        <tr>
                            <td class="lightUrlCol rawUrls">
                                <a href='<%# Eval("url").ToString()%>' target="_blank">
                                    <%# Eval("pagetitle")%></a> <a href="ViewsForPage.aspx?pageid=<%# Eval("PageID")%>&mo=true">
                                        <img src="/themes/lollipop/images/rightarrow.png" /></a>
                            </td>
                            <td>
                                <asp:Label ID="lblApplicationDescription" runat="server" />
                            </td>
                            <td>
            ...
            <div class="ActivityLinksArea">
                <a href="ViewsTopMembers.aspx">Most Active Members</a>| <a href="ViewsAllMembers.aspx">
                    All Member Activity</a>|<a href="ViewsAllPages.aspx" class="last">All Page Activity</a>
            </div>
        </div>
