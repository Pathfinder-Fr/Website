<%@ Page Language="C#" AutoEventWireup="true" Inherits="Sueetie.Analytics.Pages.ViewsAllPagesPage"
        ...
        <div class="AnalyticsReportPages">
            <div class="AdminTextTalk">
                <div class="ReportTitleSelectArea">
                    <div class="Title">
                        Analytics Page Activity Report - All Pages</div>
            ...
            <table border="1" id="PageTable" class="AgentsTable">
                ...
                <asp:Repeater ID="rptIpLog" runat="server" EnableViewState="false">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <a href="ViewsByApplication.aspx?appid=<%# Eval("ApplicationID") %>&mo=<%# chkMembersOnly.Checked %>&co=<%# chkContentOnly.Checked %>">
                                    <%# Eval("ApplicationDescription")%>
                                </a>
                            </td>
                        </tr>
                    </ItemTemplate>
                ...
                <asp:Panel ID="pnlFreeLicenseRow" runat="server">
                    <tr>
                        <td colspan="3">
                            <SUEETIE:SueetieLocal Key="analytics_report_limit" LanguageFile="Licensing.xml" runat="server" />
                        </td>
                    </tr>
                </asp:Panel>
            </table>
