<%@ Page Language="C#" AutoEventWireup="true" 
    Inherits="Sueetie.Analytics.Pages.ViewsAllMembersPage" MasterPageFile="/themes/lollipop/masters/admin.master" %>
    ...
    <div class="AdminFormArea">
        <div class="AnalyticsReportPages">
            <div class="AdminTextTalk">
                ...
                <div class="HeaderBox">
                        Member Activity for Last <strong><%= DisplayDateRange() %>. </strong>  Total Views for Period: <strong><%= TotalViews %>.</strong>
                </div>
                    <div class="TableTopSelectArea">
                  Content Pages Only <asp:CheckBox ID="chkContentOnly" runat="server" OnCheckedChanged="UpdateQuery" Checked="false"  AutoPostBack="true"/>
                 </div>
            </div>
                ...
                <asp:Repeater ID="rptIpLog" runat="server" EnableViewState="false">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                            <%# Eval("ApplicationDescription").ToString()%>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
