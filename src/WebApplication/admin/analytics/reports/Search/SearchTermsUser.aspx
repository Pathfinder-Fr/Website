<%@ Page Language="C#" AutoEventWireup="true" Inherits="Sueetie.Analytics.Pages.SearchTermsUserPage"
...
<asp:Content ID="Content5" runat="server" ContentPlaceHolderID="cphBodyTitle">
    Site Searching Activity for User
</asp:Content>
        ...
        <div class="AnalyticsReportPages">
            <div class="AdminTextTalk">
                <div class="ReportTitleSelectArea">
                    <div class="Title">
                        Site Searching Activity for User: <strong><%= DisplayName %></strong></div>
                ...
                <div class="HeaderBox">
                    <strong><%= DisplayName %></strong> Search Activity for the Last <strong>
