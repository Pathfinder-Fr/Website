...
{
    public partial class RegisteredUsers : SueetieAdminPage
    {
        public RegisteredUsers()
            : base("admin_users_registered")
        {
        }
        ...
        private void BindUserAccounts()
        {
            ...
            if (UsernameToMatch == string.Empty)
                UsersGridView.DataSource = users.Skip(this.PageIndex * this.PageSize).Take(this.PageSize);
            else
