<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InactiveUsers.aspx.cs" Inherits="Sueetie.Web.InactiveUsers" %>
...
<asp:Content ID="Content7" runat="server" contentplaceholderid="cphContentBody">
    ...
    <asp:GridView ID="UsersGridView"  runat="server" AutoGenerateColumns="False" CssClass="gridviewMain" DataKeyNames="userName" EmptyDataText="No records found.">
