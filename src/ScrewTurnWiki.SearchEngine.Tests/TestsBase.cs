...
namespace ScrewTurn.Wiki.SearchEngine.Tests
{
    public class TestsBase
    {
        ...
        /// </summary>
        protected WordInfo[] PlainTextDocumentWords =
        {
        ...
        /// </summary>
        protected WordInfo[] PlainTextDocumentWords2 =
        {
        ...
        /// </summary>
        protected WordInfo[] PlainTextDocumentWords3 =
        {
        ...
        /// </summary>
        protected WordInfo[] PlainTextDocumentWords4 =
        {
        ...
        {
            var index = looseMocks.DynamicMock<InMemoryIndexBase>();
        ...
        {
            var doc = looseMocks.DynamicMock<IDocument>();
        ...
        {
            var ids = new List<WordId>();
            if (e.ChangeData != null && e.ChangeData.Words != null)
            {
                foreach (var w in e.ChangeData.Words)
                {
