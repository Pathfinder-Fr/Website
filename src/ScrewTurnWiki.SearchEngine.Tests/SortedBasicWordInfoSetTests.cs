...
namespace ScrewTurn.Wiki.SearchEngine.Tests
{
    ...
    public class SortedBasicWordInfoSetTests : TestsBase
    {
        ...
        {
            var set = new SortedBasicWordInfoSet();
            Assert.IsTrue(set.Add(new BasicWordInfo(10, 1, WordLocation.Content)),
                "Add should return true (adding new item)");
            Assert.AreEqual(1, set.Count, "Wrong count (set should contain 1 item)");
        }
        ...
        {
            var set = new SortedBasicWordInfoSet();
            Assert.IsTrue(set.Add(new BasicWordInfo(10, 2, WordLocation.Content)),
                "Add should return true (adding new item)");
            Assert.IsTrue(set.Add(new BasicWordInfo(2, 1, WordLocation.Content)),
                "Add should return true (adding new item)");
            ...
            Assert.IsFalse(set.Contains(new BasicWordInfo(10, 2, WordLocation.Content)),
                "Contains should return false (empty set)");
            Assert.IsFalse(set.Contains(new BasicWordInfo(2, 1, WordLocation.Content)),
                "Contains should return false (empty set)");
        }
        ...
        {
            var set = new SortedBasicWordInfoSet(10);
            Assert.AreEqual(0, set.Count, "Wrong count (set should be empty)");
        ...
        public void GetEnumerator()
        {
            ...
            Assert.IsTrue(set.Add(new BasicWordInfo(1, 0, WordLocation.Content)),
                "Add should return true (adding new item)");
            Assert.IsTrue(set.Add(new BasicWordInfo(3, 1, WordLocation.Content)),
                "Add should return true (adding new item)");
        ...
        public void Indexer()
        {
            ...
            Assert.IsTrue(set.Add(new BasicWordInfo(10, 1, WordLocation.Content)),
                "Add should return true (adding new item)");
            Assert.IsTrue(set.Add(new BasicWordInfo(3, 2, WordLocation.Content)),
                "Add should return true (adding new item)");
