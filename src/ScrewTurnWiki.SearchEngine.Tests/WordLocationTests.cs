...
namespace ScrewTurn.Wiki.SearchEngine.Tests
{
    ...
    public class WordLocationTests
    {
        ...
        public void StaticInstances_CompareTo()
        {
            ...
            Assert.AreEqual(1, WordLocation.Content.CompareTo(WordLocation.Title),
                "Content should be greater than Title");
            Assert.AreEqual(-1, WordLocation.Title.CompareTo(WordLocation.Content),
                "Title should be smaller than Content");
        }

        [Test]
        public void StaticInstances_Content()
        {
            var loc1 = WordLocation.Content;
            var loc2 = WordLocation.Content;
        ...
        {
            var loc1 = WordLocation.Keywords;
            var loc2 = WordLocation.Keywords;
        ...
        {
            Assert.IsTrue(WordLocation.Title.RelativeRelevance > WordLocation.Keywords.RelativeRelevance,
                "Wrong relevance relationship");
            Assert.IsTrue(WordLocation.Keywords.RelativeRelevance > WordLocation.Content.RelativeRelevance,
                "Wrong relevance relationship");
        }
        ...
        {
            var loc1 = WordLocation.Title;
            var loc2 = WordLocation.Title;
