...
namespace ScrewTurn.Wiki
{
    ...
    public static class UrlTools
    {
        ...
        public static void RouteCurrentRequest()
        {
            ...
            var pageName = Path.GetFileNameWithoutExtension(physicalPath);
            // Exctract the extension, e.g. .ashx or .aspx
            var ext = Path.GetExtension(HttpContext.Current.Request.PhysicalPath).ToLowerInvariant();
            ...
            var nspace = GetCurrentNamespace() + "";
            ...
            var queryString = ""; // Empty or begins with ampersand, not question mark
            try
            {
        ...
        {
            var filename = Path.GetFileNameWithoutExtension(HttpContext.Current.Request.Path); // e.g. MainPage or Edit or Namespace.MainPage or Namespace.Edit
