...
namespace ScrewTurn.Wiki
{
    ...
    public static class SearchTools
    {
        ...
        private static void TraverseDirectories(InMemoryIndexBase index, IFilesStorageProviderV30 provider, string currentDir)
        {
            ...
            foreach (var file in provider.ListFiles(currentDir))
            {
            ...
            foreach (var directory in provider.ListDirectories(currentDir))
            {
        ...
        {
            var tempResults = new List<SearchResult>(100);
            ...
            var resultCollection = new SearchResultCollection(50);
