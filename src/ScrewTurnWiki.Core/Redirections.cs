...
namespace ScrewTurn.Wiki
{
    ...
    public static class Redirections
    {
        ...
        public static PageInfo GetDestination(PageInfo page, out string fragment)
        {
            if (page == null) throw new ArgumentNullException("page");

            var destination = Cache.Provider.GetRedirectionDestination(page.FullName);
            ...
            return Pages.FindPage(destination.FullName);
        }
