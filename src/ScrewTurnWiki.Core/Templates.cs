...
namespace ScrewTurn.Wiki
{
    ...
    public static class Templates
    {
        ...
        {
            var result = new List<ContentTemplate>(20);
        ...
        public static ContentTemplate Find(string name)
        {
            ...
            var index = templates.BinarySearch(new ContentTemplate(name, "", null), new ContentTemplateNameComparer());
        ...
        {
            var done = template.Provider.RemoveContentTemplate(template.Name);
