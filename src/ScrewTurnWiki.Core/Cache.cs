...
namespace ScrewTurn.Wiki
{
    ...
    public static class Cache
    {
        ...
        public static string GetPageTitle(PageInfo page)
        {
            if (page == null) return null;
            return Provider.GetPageTitle(page);
        }

        public static void SetPageTitle(PageInfo page, string title)
        {
            Provider.SetPageTitle(page, title);
        }
