...
namespace ScrewTurn.Wiki
{
    ...
    public static class Settings
    {
        ...
        public static string MasterPassword
        {
            get
            {
                var pass = WebConfigurationManager.AppSettings["MasterPassword"];
        ...
        public static string UploadUrl => WebConfigurationManager.AppSettings["UploadUrl"];
        ...
        public static string PublicDirectory
        {
            get
            {
                ...
                var pubDirName = PublicDirectoryName;
                if (Path.IsPathRooted(pubDirName)) return pubDirName;
                else
                {
                    var path = Path.Combine(RootDirectory, pubDirName);
        ...
        private static string PublicDirectoryName
        {
            get
            {
                var dir = WebConfigurationManager.AppSettings["PublicDirectory"];
        ...
        public static AccountActivationMode AccountActivationMode
        {
            get
            {
                var value = GetString(Provider.GetSetting("AccountActivationMode"), "EMAIL");
        ...
        public static ChangeModerationMode ChangeModerationMode
        {
            get
            {
                var value = GetString(Provider.GetSetting("ChangeModerationMode"),
        ...
        public static int DefaultTimezone
        {
            get
            {
                var value = GetString(Provider.GetSetting("DefaultTimezone"), "0");
        ...
        public static string MainUrl
        {
            get
            {
                var s = GetString(Provider.GetSetting("MainUrl"), "http://www.server.com/");
                if (!s.EndsWith("/")) s += "/";
                return s;
            }
            set
        ...
        public static Uri GetMainUrl()
        {
            ...
            if (mainUrl.Host == "www.server.com")
            {
                try
                {
                    ...
                    var temp = HttpContext.Current.Request.Url.ToString();
        ...
        public static string CookiePath
        {
            get
            {
                ...
                var virtualDirectory = HttpContext.Current.Request.ApplicationPath;
        ...
        /// </summary>
        public static bool IgnoreSingleSquareBrackets
        {
            get
            {
                return GetBool(Provider.GetSetting("IgnoreSingleSquareBrackets"), false);
            }
            set
            {
                Provider.SetSetting("IgnoreSingleSquareBrackets", PrintBool(value));
            }
        }
        ...
        public static string GetTheme(string nspace)
        {
            ...
            var propertyName = "Theme" + (!string.IsNullOrEmpty(nspace) ? "-" + nspace : "");
        ...
        public static string[] AllowedFileTypes
        {
            get
            {
                var raw = GetString(Provider.GetSetting("AllowedFileTypes"), "jpg|jpeg|gif|png|tif|tiff|bmp|svg|htm|html|zip|rar|pdf|txt|doc|xls|ppt|docx|xlsx|pptx");
        ...
        public static FileDownloadCountFilterMode FileDownloadCountFilterMode
        {
            get
            {
                var raw = GetString(Provider.GetSetting("FileDownloadCountFilterMode"), FileDownloadCountFilterMode.CountAll.ToString());
        ...
        public static string[] FileDownloadCountFilter
        {
            get
            {
                var raw = GetString(Provider.GetSetting("FileDownloadCountFilter"), "");
                return raw.ToLowerInvariant().Split(new char[] { '|' }, StringSplitOptions.RemoveEmptyEntries);
            }
            set
            {
        ...
        public static LoggingLevel LoggingLevel
        {
            get
            {
                var value = GetInt(Provider.GetSetting("LoggingLevel"), 3);
        ...
        public static RssFeedsMode RssFeedsMode
        {
            get
            {
                var value = GetString(Provider.GetSetting("RssFeedsMode"), RssFeedsMode.Summary.ToString());
