...
namespace ScrewTurn.Wiki
{
    ...
    public static class Content
    {
        ...
        public static string GetPageTitle(PageInfo pageInfo, bool cached)
        {
            var title = Cache.GetPageTitle(pageInfo);

            if (title == null)
            {
                title = pageInfo.Provider.GetTitle(pageInfo);
                Cache.SetPageTitle(pageInfo, title);
            }
