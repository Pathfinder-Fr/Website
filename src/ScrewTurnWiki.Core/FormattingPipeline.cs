...
namespace ScrewTurn.Wiki
{
    ...
    public static class FormattingPipeline
    {
        ...
        private static IEnumerable<IFormatterProviderV30> GetSortedFormatters()
        {
            return Collectors
                .FormatterProviderCollector
                .AllProviders
                .OrderBy(x => x.ExecutionPriority)
                .ThenBy(x => x.Information.Name);
        }
        ...
        {
            return FormatWithPhase1And2(raw, forIndexing, context, current, out var tempLinks);
        }
        ...
        public static string FormatWithPhase1And2(string raw, bool forIndexing, FormattingContext context, PageInfo current, out IList<string> linkedPages)
        {
            ...
            info = new ContextInformation(forIndexing, false, context, current, System.Threading.Thread.CurrentThread.CurrentCulture.Name, HttpContext.Current, username, SessionFacade.GetCurrentGroupNames());

            var providers = GetSortedFormatters();
        ...
        {
            var temp = title;
            var info = new ContextInformation(forIndexing, false, context, current, System.Threading.Thread.CurrentThread.CurrentCulture.Name,
