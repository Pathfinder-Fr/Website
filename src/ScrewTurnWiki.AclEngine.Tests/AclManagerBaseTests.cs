...
namespace ScrewTurn.Wiki.AclEngine.Tests
{
    ...
    public class AclManagerBaseTests
    {
        ...
        {
            var manager = mocks.DynamicMock<AclManagerBase>();
        ...
        public void DeleteEntriesForResource_RetrieveAllEntries()
        {
            ...
            Assert.IsTrue(manager.StoreEntry("Res2", "Action2", "G.Group2", Value.Grant),
            ...
            Assert.IsFalse(manager.DeleteEntriesForResource("Inexistent"),
                "DeleteEntriesForResource should return false");
        ...
        public void DeleteEntriesForSubject_RetrieveAllEntries()
        {
            ...
            Assert.IsFalse(manager.DeleteEntriesForSubject("I.Inexistent"),
                "DeleteEntriesForSubject should return false");
        ...
        public void Event_AclChanged_OverwriteEntry()
        {
            ...
            var entryOld = new AclEntry("Res", "Action", "U.User", Value.Deny);

            var entryNew = new AclEntry("Res", "Action", "U.User", Value.Grant);
        ...
        public void RenameResource()
        {
            ...
            var entry1 = new AclEntry("Res", "Action", "U.User", Value.Grant);
            var newEntry1 = new AclEntry("Res_Renamed", "Action", "U.User", Value.Grant);
            var entry2 = new AclEntry("Res", "Action2", "U.User2", Value.Deny);
            var newEntry2 = new AclEntry("Res_Renamed", "Action2", "U.User", Value.Deny);
            ...
            var invokedDelete1 = false;
            var invokedStore1 = false;
            var invokedDelete2 = false;
            var invokedStore2 = false;
            manager.AclChanged += delegate (object sender, AclChangedEventArgs e)
            {
            ...
            var entries = manager.RetrieveAllEntries().ToArray();
        ...
        public void RetrieveEntriesForResource()
        {
            ...
            Assert.AreEqual(0, manager.RetrieveEntriesForResource("Inexistent").ToArray().Length, "Wrong result count");

            var allEntries = manager.RetrieveEntriesForResource("Res").ToArray();
            Assert.AreEqual(2, allEntries.Length, "Wrong entry count");
        ...
        public void RetrieveEntriesForSubject()
        {
            ...
            Assert.AreEqual(0, manager.RetrieveEntriesForSubject("I.Inexistent").ToArray().Length, "Wrong result count");

            var allEntries = manager.RetrieveEntriesForSubject("G.Group2").ToArray();
            Assert.AreEqual(2, allEntries.Length, "Wrong entry count");
        ...
        public void StoreEntry_RetrieveAllEntries()
        {
            ...
            Assert.AreEqual(0, manager.RetrieveAllEntries().ToArray().Length, "Wrong initial entry count");
