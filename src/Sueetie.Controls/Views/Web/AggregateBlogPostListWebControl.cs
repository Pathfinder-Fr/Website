...
{
    public class AggregateBlogPostListWebControl : SueetieBaseControl
    {
        protected PlaceHolder phAggregatedBlogPosts;

        public AggregateBlogPostListWebControl()
        {
            NumRecords = 10;
            UserID = -2;
            GroupID = -1;
            ApplicationID = -1;
            IsRestricted = true;
            ViewName = "AggregateBlogPostView";
            CacheMinutes = 5;
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            foreach (SueetieBlogPost post in sueetieBlogPosts)
            {
                ...
                control.Post = post;
                phAggregatedBlogPosts.Controls.Add(control);
            }
