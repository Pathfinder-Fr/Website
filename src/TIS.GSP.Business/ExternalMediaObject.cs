...
namespace GalleryServerPro.Business
{
	...
	public class ExternalMediaObject : GalleryObject
	{
		...
		internal ExternalMediaObject(string externalHtmlSource, MimeTypeCategory mimeType, IAlbum parentAlbum)
			: this(int.MinValue, parentAlbum, string.Empty, string.Empty, string.Empty, int.MinValue, int.MinValue, int.MinValue,
						string.Empty, int.MinValue, int.MinValue, int.MinValue, externalHtmlSource, mimeType, int.MinValue, String.Empty,
