...
namespace GalleryServerPro.Business
{
	...
	public static class ImageHelper
	{
		...
		/// cannot be resized to the requested dimensions. Typically this will occur during <see cref="Graphics.DrawImage"/> because there is 
		/// not enough system memory.</exception>
		public static Bitmap CreateResizedBitmap(System.Drawing.Image inputBmp, int sourceBmpWidth, int sourceBmpHeight, int newWidth, int newHeight)
		{
			...
			Bitmap newBmp = new Bitmap(calculatedNewWidth, calculatedNewHeight, PixelFormat.Format24bppRgb);//Graphics.FromImage doesn't like Indexed pixel format
