...
namespace GalleryServerPro.Business
{
	...
	public class GalleryServerRoleCollection : Collection<IGalleryServerRole>, IGalleryServerRoleCollection
	{
		...
		/// <summary>
		/// Sort the objects in this collection by <see cref="IGalleryServerRole.GalleryId">gallery ID</see> first, then by 
		/// <see cref="IGalleryServerRole.RoleName">gallery ID</see>.
		/// </summary>
		public void Sort()
		{
