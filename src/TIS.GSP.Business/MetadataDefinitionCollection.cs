...
namespace GalleryServerPro.Business
{
	...
	public class MetadataDefinitionCollection : KeyedCollection<FormattedMetadataItemName, IMetadataDefinition>, IMetadataDefinitionCollection
	{
		...
		/// </summary>
		/// <param name="metadataDefinition">The metadata definition to add.</param>
		public new void Add(IMetadataDefinition metadataDefinition)
		{
			if (metadataDefinition == null)
				throw new ArgumentNullException("metadataDefinition", "Cannot add null to an existing MetadataDefinitionCollection. Items.Count = " + Items.Count);

			base.Add(metadataDefinition);
		}
		...
		/// <summary>
		/// Generates as string representation of the items in the collection. Use this to convert the collection that can be stored in the
