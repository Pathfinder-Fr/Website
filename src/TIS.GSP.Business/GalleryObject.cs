...
namespace GalleryServerPro.Business
{
	...
	public abstract class GalleryObject : IGalleryObject, IComparable
	{
		...
		{
			get { return this._isWriteable; }
			set { this._isWriteable = value; }
		}
		...
		protected virtual string ValidateTitle(string title)
		{
			...
			const int maxLength = DataConstants.MediaObjectTitleLength;
		...
		private void VerifyInstanceIsUpdateable()
		{
			if (!IsWriteable)
			{
				throw new BusinessException(string.Format("This gallery object (ID {0}, {1}) is not updateable.", this.Id, this.GetType()));
			}
		}
		...
		public int CompareTo(object other)
		{
			...
			else
			{
				...
				bool otherIsMediaObj = ((other is IGalleryObject) && (otherAsAlbum == null));
