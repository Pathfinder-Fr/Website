...
namespace GalleryServerPro.Business.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Default Gallery Object Media Object Invalid: The gallery &apos;{0}&apos; has a media object ID specified ({1}) as the default gallery object and it does not match an existing medai object. Review this setting in the administration area..
        /// </summary>
