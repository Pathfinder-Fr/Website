...
namespace GalleryServerPro.Business
{
	...
	public class BrowserTemplateCollection : Collection<IBrowserTemplate>, IBrowserTemplateCollection
	{
		...
		/// </summary>
		/// <param name="browserTemplate">The browser template to add.</param>
		public new void Add(IBrowserTemplate browserTemplate)
		{
			if (browserTemplate == null)
				throw new ArgumentNullException("browserTemplate", "Cannot add null to an existing BrowserTemplateCollection. Items.Count = " + Items.Count);

			base.Add(browserTemplate);
		}
		...
		public IBrowserTemplate Get(Array browserIds)
		{
		...
		public IBrowserTemplate Get(string browserId)
		{
