	...
	public class GallerySettings : IGallerySettings
	{
		...
		public int EmptyAlbumThumbnailFontSize
		{
			...
			set
			{
				...
				{
					throw new ArgumentOutOfRangeException("value", string.Format("Invalid EmptyAlbumThumbnailFontSize setting: The value must be between 6 and 100. Instead, the value was {0}.", value));
				}
		...
		public float EmptyAlbumThumbnailWidthToHeightRatio
		{
			...
			set
			{
				if (value <= 0)
				{
					throw new ArgumentOutOfRangeException("value", string.Format("Invalid EmptyAlbumThumbnailWidthToHeightRatio setting: The value must be greater than zero. Instead, the value was {0}.", value));
				}
		...
		public MediaObjectTransitionType MediaObjectTransitionType
		{
			...
			set
			{
				...
				{
					throw new System.ComponentModel.InvalidEnumArgumentException(string.Format("The configuration setting MediaObjectTransitionType is not one of the enum values of the MediaObjectTransitionType enumeration. Valid values are 'None' and 'Fade'. Instead, the value {0} was passed.", value));
				}
		...
		public float MediaObjectTransitionDuration
		{
			...
			set
			{
				if (value <= 0)
				{
					throw new ArgumentOutOfRangeException("value", string.Format("Invalid MediaObjectTransitionDuration setting: The value must be greater than zero. Instead, the value was {0}.", value));
				}
		...
		public int SlideshowInterval
		{
			...
			set
			{
				if (value < 1)
				{
					throw new ArgumentOutOfRangeException("value", string.Format("Invalid SlideshowInterval setting: The value must be greater than one. Instead, the value was {0}.", value));
				}
		...
		public int MaxThumbnailLength
		{
			...
			set
			{
				...
				{
					throw new ArgumentOutOfRangeException("value", string.Format("Invalid MaxThumbnailLength setting: The value must be between 10 and 100,000. Instead, the value was {0}.", value));
				}
		...
		public int ThumbnailImageJpegQuality
		{
			...
			set
			{
				...
				{
					throw new ArgumentOutOfRangeException("value", string.Format("Invalid ThumbnailImageJpegQuality setting: The value must be between 1 and 100. Instead, the value was {0}.", value));
				}
		...
		public int ThumbnailWidthBuffer
		{
			...
			set
			{
				...
				{
					throw new ArgumentOutOfRangeException("value", string.Format("Invalid ThumbnailWidthBuffer setting: The value must be between 0 and 1,000. Instead, the value was {0}.", value));
				}
		...
		public int ThumbnailHeightBuffer
		{
			...
			set
			{
				if ((value < 0) || (value > 1000))
				{
					throw new ArgumentOutOfRangeException("value", string.Format("Invalid ThumbnailHeightBuffer setting: The value must be between 0 and 1,000. Instead, the value was {0}.", value));
				}
		...
		public int MaxOptimizedLength
		{
			...
			set
			{
				if ((value < 10) || (value > 100000))
				{
					throw new ArgumentOutOfRangeException("value", string.Format("Invalid MaxOptimizedLength setting: The value must be between 10 and 100,000. Instead, the value was {0}.", value));
				}
		...
		public int OptimizedImageJpegQuality
		{
			...
			set
			{
				if ((value < 1) || (value > 100))
				{
					throw new ArgumentOutOfRangeException("value", string.Format("Invalid OptimizedImageJpegQuality setting: The value must be between 1 and 100. Instead, the value was {0}.", value));
				}
		...
		public int OptimizedImageTriggerSizeKb
		{
			...
			set
			{
				if (value < 0)
				{
					throw new ArgumentOutOfRangeException("value", string.Format("Invalid OptimizedImageTriggerSizeKb setting: The value must be greater than or equal to zero. Instead, the value was {0}.", value));
				}
		...
		public int OriginalImageJpegQuality
		{
			...
			set
			{
				if ((value < 1) || (value > 100))
				{
					throw new ArgumentOutOfRangeException("value", string.Format("Invalid OriginalImageJpegQuality setting: The value must be between 1 and 100. Instead, the value was {0}.", value));
				}
		...
		public int WatermarkTextFontSize
		{
			...
			set
			{
				...
				{
					throw new ArgumentOutOfRangeException("value", string.Format("Invalid WatermarkTextFontSize setting: The value must be between 0 and 10000. Instead, the value was {0}.", value));
				}
		...
		public int WatermarkTextWidthPercent
		{
			...
			set
			{
				...
				{
					throw new ArgumentOutOfRangeException("value", string.Format("Invalid WatermarkTextWidthPercent setting: The value must be between 0 and 100. Instead, the value was {0}.", value));
				}
		...
		public int WatermarkTextOpacityPercent
		{
			...
			set
			{
				if ((value < 0) || (value > 100))
				{
					throw new ArgumentOutOfRangeException("value", string.Format("Invalid WatermarkTextOpacityPercent setting: The value must be between 0 and 100. Instead, the value was {0}.", value));
				}
		...
		public ContentAlignment WatermarkTextLocation
		{
			...
			set
			{
				...
				{
					throw new System.ComponentModel.InvalidEnumArgumentException(string.Format("The configuration setting WatermarkTextLocation is not one of the enum values of the System.Drawing.ContentAlignment enumeration. Valid values are 'BottomCenter', 'BottomLeft', 'BottomRight', 'MiddleCenter', 'MiddleLeft', 'MiddleRight', 'TopCenter', 'TopLeft', 'TopRight'. Instead, the value {0} was passed.", value));
				}
		...
		public int WatermarkImageWidthPercent
		{
			...
			set
			{
				if ((value < 0) || (value > 100))
				{
					throw new ArgumentOutOfRangeException("value", string.Format("Invalid WatermarkImageWidthPercent setting: The value must be between 0 and 100. Instead, the value was {0}.", value));
				}
		...
		public int WatermarkImageOpacityPercent
		{
			...
			set
			{
				if ((value < 0) || (value > 100))
				{
					throw new ArgumentOutOfRangeException("value", string.Format("Invalid WatermarkImageOpacityPercent setting: The value must be between 0 and 100. Instead, the value was {0}.", value));
				}
		...
		public ContentAlignment WatermarkImageLocation
		{
			...
			set
			{
				if (!ContentAlignmentEnumHelper.IsValidContentAlignment(value))
				{
					throw new System.ComponentModel.InvalidEnumArgumentException(string.Format("The configuration setting WatermarkImageLocation is not one of the enum values of the System.Drawing.ContentAlignment enumeration. Valid values are 'BottomCenter', 'BottomLeft', 'BottomRight', 'MiddleCenter', 'MiddleLeft', 'MiddleRight', 'TopCenter', 'TopLeft', 'TopRight'. Instead, the value {0} was passed.", value));
				}
		...
		public string EmailFromAddress
		{
			...
			set
			{
				...
				{
					throw new ArgumentOutOfRangeException("value", string.Format("Invalid EmailFromAddress setting: The value must be a valid e-mail address. Instead, the value was {0}.", value));
				}
		...
		public int DefaultVideoPlayerWidth
		{
			...
			set
			{
				if ((value < 0) || (value > 10000))
				{
					throw new ArgumentOutOfRangeException("value", string.Format("Invalid DefaultVideoPlayerWidth setting: The value must be between 0 and 10,000. Instead, the value was {0}.", value));
				}
		...
		public int DefaultVideoPlayerHeight
		{
			...
			set
			{
				if ((value < 0) || (value > 10000))
				{
					throw new ArgumentOutOfRangeException("value", string.Format("Invalid DefaultVideoPlayerHeight setting: The value must be between 0 and 10,000. Instead, the value was {0}.", value));
				}
		...
		public int DefaultAudioPlayerWidth
		{
			...
			set
			{
				if ((value < 0) || (value > 10000))
				{
					throw new ArgumentOutOfRangeException("value", string.Format("Invalid DefaultAudioPlayerWidth setting: The value must be between 0 and 10,000. Instead, the value was {0}.", value));
				}
		...
		public int DefaultAudioPlayerHeight
		{
			...
			set
			{
				if ((value < 0) || (value > 10000))
				{
					throw new ArgumentOutOfRangeException("value", string.Format("Invalid DefaultAudioPlayerHeight setting: The value must be between 0 and 10,000. Instead, the value was {0}.", value));
				}
		...
		public int DefaultGenericObjectWidth
		{
			...
			set
			{
				if ((value < 0) || (value > 10000))
				{
					throw new ArgumentOutOfRangeException("value", string.Format("Invalid DefaultGenericObjectWidth setting: The value must be between 0 and 10,000. Instead, the value was {0}.", value));
				}
		...
		public int DefaultGenericObjectHeight
		{
			...
			set
			{
				if ((value < 0) || (value > 10000))
				{
					throw new ArgumentOutOfRangeException("value", string.Format("Invalid DefaultGenericObjectHeight setting: The value must be between 0 and 10,000. Instead, the value was {0}.", value));
				}
		...
		public int MaxUploadSize
		{
			...
			set
			{
				if (value < 0)
				{
					throw new ArgumentOutOfRangeException("value", string.Format("Invalid MaxUploadSize setting: The value must be between 0 and {0}. Instead, the value was {1}.", Int32.MaxValue, value));
				}
		...
		public int PageSize
		{
			...
			set
			{
				if (value < 0)
				{
					throw new ArgumentOutOfRangeException("value", string.Format("Invalid PageSize setting: The value must be between 0 and {0}. Instead, the value was {1}.", Int32.MaxValue, value));
				}
		...
		public PagerPosition PagerLocation
		{
			...
			set
			{
				...
				{
					throw new System.ComponentModel.InvalidEnumArgumentException(string.Format("The configuration setting PagerLocation is not one of the enum values of the PagerPosition enumeration. Valid values are 'Top', 'Bottom', and 'TopAndBottom'. Instead, the value {0} was passed.", value));
				}
		...
		public int VideoThumbnailPosition
		{
			...
			set
			{
				...
				{
					throw new ArgumentOutOfRangeException("value", string.Format("Invalid VideoThumbnailPosition setting: The value must be between 0 and 86400 (24 hours). Instead, the value was {0}.", value));
				}
		...
		private void ValidateSave()
		{
			if (!IsWriteable)
			{
				throw new BusinessException(string.Format("This gallery setting container (Gallery ID {0}, {1}) is not updateable.", this.GalleryId, this.GetType()));
			}
		}
		...
		internal static IGallerySettingsCollection RetrieveGallerySettingsFromDataStore()
		{
			...
			try
			{
				...
				using (dr = Factory.GetDataProvider().GallerySetting_GetDataReaderGallerySettings())
				{
					...
					while (dr.Read())
					{
						...
						int currGalleryId = Convert.ToInt32(dr["FKGalleryId"].ToString().Trim(), CultureInfo.InvariantCulture);
						...
						if (!prevGalleryId.HasValue || (currGalleryId != prevGalleryId))
						{
							...
							bool isTemplate = Convert.ToBoolean(dr["IsTemplate"].ToString().Trim(), CultureInfo.InvariantCulture);
						...
						if (prop == null)
						{
							throw new MissingMemberException(string.Format("Invalid gallery setting. A gallery setting named '{0}' was found in the data store, but no property by that name exists in the class '{1}'. Check the gallery settings in the data store to ensure they are correct.", settingName, gsType));
						}
						...
						{
							prop.SetValue(gs, Convert.ToBoolean(dr["SettingValue"].ToString().Trim(), CultureInfo.InvariantCulture), null);
						}
						else if (prop.PropertyType.FullName.Equals(stringType))
						{
							prop.SetValue(gs, Convert.ToString(dr["SettingValue"].ToString().Trim(), CultureInfo.InvariantCulture), null);
						}
						else if (prop.PropertyType.FullName.Equals(intType))
						{
							prop.SetValue(gs, Convert.ToInt32(dr["SettingValue"].ToString().Trim(), CultureInfo.InvariantCulture), null);
						}
						else if (prop.PropertyType.FullName.Equals(floatType))
						{
							prop.SetValue(gs, Convert.ToSingle(dr["SettingValue"].ToString().Trim(), CultureInfo.InvariantCulture), null);
						}
						else if (prop.PropertyType.FullName.Equals(dateTimeType))
						{
							prop.SetValue(gs, HelperFunctions.ToDateTime(dr["SettingValue"].ToString().Trim(), "O", CultureInfo.InvariantCulture), null);
						}
						else if (prop.PropertyType.FullName.Equals(stringArrayType))
						{
							// Parse comma-delimited string to array
							string[] strings = dr["SettingValue"].ToString().Split(new char[] { ',' }, StringSplitOptions.RemoveEmptyEntries);
						...
						{
							AssignMediaObjectTransitionTypeProperty(gs, prop, dr["SettingValue"].ToString().Trim());
						}
						else if (prop.PropertyType == typeof(ContentAlignment))
						{
							AssignContentAlignmentProperty(gs, prop, dr["SettingValue"].ToString().Trim());
						}
						else if (prop.PropertyType == typeof(PagerPosition))
						{
							AssignPagerPositionProperty(gs, prop, dr["SettingValue"].ToString().Trim());
						}
						else if (prop.PropertyType == typeof(IUserAccountCollection))
						{
							AssignUserAccountsProperty(gs, prop, dr["SettingValue"].ToString().Split(new char[] { ',' }, StringSplitOptions.RemoveEmptyEntries));
						}
						else if (prop.PropertyType == typeof(IMetadataDefinitionCollection))
						{
							AssignMetadataDisplaySettingsProperty(gs, prop, dr["SettingValue"].ToString().Split(new char[] { ',' }, StringSplitOptions.RemoveEmptyEntries));
						}
						else
						{
							throw new ArgumentOutOfRangeException(String.Format("GallerySettings.RetrieveGallerySettingsFromDataStore is not designed to process a property of type {0} (encountered in GallerySettings.{1})", prop.PropertyType, prop.Name));
						}
		...
		private static void AssignMetadataDisplaySettingsProperty(IGallerySettings gallerySetting, PropertyInfo property, string[] metadata)
		{
			...
			foreach (string nameValuePair in metadata)
			{
				...
				{
					throw new ArgumentOutOfRangeException(String.Format("GallerySetting.RetrieveGallerySettingsFromDataStore cannot parse the metadata definitions for property {0}. Encountered invalid string: '{1}'", property.Name, nameValuePair));
				}
				...
				if (Int32.TryParse(nameOrValue[0], out metadataDefInt))
				{
					...
					{
						throw new ArgumentOutOfRangeException(String.Format("The integer {0} does not map to a known value of {1}. Details: The function FormattedMetadataItemNameEnumHelper.IsValidFormattedMetadataItemName() returned false when evaluating this value. If the enumeration definition has recently changed, this function must be updated to include the change. The MetadataDisplaySettings property in the gallery settings table may need to be manually updated to remove references to this invalid enumeration value.", metadataDefInt, typeof(FormattedMetadataItemName)));
					}
				}
				else
				{
		...
		private static void AssignMediaObjectTransitionTypeProperty(IGallerySettings gallerySetting, PropertyInfo property, string value)
		{
			...
			{
				throw new ArgumentOutOfRangeException(String.Format("GallerySetting.RetrieveGallerySettingsFromDataStore cannot convert the string {0} to a MediaObjectTransitionType enumeration value. The following values are valid: None, Fade", value), ex);
			}
		...
		private static void AssignContentAlignmentProperty(IGallerySettings gallerySetting, PropertyInfo property, string value)
		{
			...
			{
				throw new ArgumentOutOfRangeException(String.Format("GallerySetting.RetrieveGallerySettingsFromDataStore cannot convert the string {0} to a ContentAlignment enumeration value. The following values are valid: TopLeft, TopCenter, TopRight, MiddleLeft, MiddleCenter, MiddleRight, BottomLeft, BottomCenter, BottomRight", value), ex);
			}
		...
		private static void AssignPagerPositionProperty(IGallerySettings gallerySetting, PropertyInfo property, string value)
		{
			...
			{
				throw new ArgumentOutOfRangeException(String.Format("GallerySetting.RetrieveGallerySettingsFromDataStore cannot convert the string {0} to a PagerPosition enumeration value. The following values are valid: Top, Bottom, TopAndBottom", value), ex);
			}
