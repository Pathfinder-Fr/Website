    ...
    public class AuthWriterTests
    {
        ...
        public void SetPermissionForDirectory_Group_InvalidDirectory(string d)
        {
            ...
            AuthWriter.SetPermissionForDirectory(AuthStatus.Grant, filesProv, d, Actions.ForDirectories.DownloadFiles,
                new UserGroup("Group", "Group", null));
        }
        ...
        public void RemoveEntriesForDirectory_User_InvalidDirectory(string d)
        {
            ...
            var fProv = mocks.DynamicMock<IFilesStorageProviderV30>();
            mocks.Replay(fProv);
            AuthWriter.RemoveEntriesForDirectory(
        ...
        public void ClearEntriesForNamespace()
        {
            ...
            Expect.Call(aclManager.DeleteEntriesForResource(Actions.ForNamespaces.ResourceMasterPrefix + "NS"))
                .Return(true);
            Expect.Call(aclManager.DeleteEntriesForResource(Actions.ForPages.ResourceMasterPrefix + "NS.Page1"))
                .Return(true);
            Expect.Call(aclManager.DeleteEntriesForResource(Actions.ForPages.ResourceMasterPrefix + "NS.Page2"))
                .Return(true);
            Expect.Call(aclManager.DeleteEntriesForResource(Actions.ForPages.ResourceMasterPrefix + "NS.Page3"))
                .Return(true);
        ...
        public void ClearEntriesForPage()
        {
            ...
            Expect.Call(aclManager.DeleteEntriesForResource(Actions.ForPages.ResourceMasterPrefix + "Page"))
                .Return(true);
        ...
        public void ProcessDirectoryRenaming()
        {
            ...
            Expect.Call(aclManager.RenameResource(
                ...
                Actions.ForDirectories.ResourceMasterPrefix + AuthTools.GetDirectoryName(filesProv, "/Dir2/")))
                .Return(true);
            ...
            Collectors.SettingsProvider = prov;
            Assert.IsTrue(AuthWriter.ProcessDirectoryRenaming(filesProv, "/Dir/", "/Dir2/"),
                "ProcessDirectoryRenaming should return true");
        ...
        public void ProcessNamespaceRenaming()
        {
            ...
            Expect.Call(aclManager.RenameResource(Actions.ForNamespaces.ResourceMasterPrefix + "NS",
                Actions.ForNamespaces.ResourceMasterPrefix + "NS_Renamed")).Return(true);
            Expect.Call(aclManager.RenameResource(Actions.ForPages.ResourceMasterPrefix + "NS.Page1",
                Actions.ForPages.ResourceMasterPrefix + "NS_Renamed.Page1")).Return(true);
            Expect.Call(aclManager.RenameResource(Actions.ForPages.ResourceMasterPrefix + "NS.Page2",
                Actions.ForPages.ResourceMasterPrefix + "NS_Renamed.Page2")).Return(true);
            Expect.Call(aclManager.RenameResource(Actions.ForPages.ResourceMasterPrefix + "NS.Page3",
                Actions.ForPages.ResourceMasterPrefix + "NS_Renamed.Page3")).Return(true);

            mocks.Replay(prov);
            mocks.Replay(aclManager);

            Collectors.SettingsProvider = prov;
            Assert.IsTrue(AuthWriter.ProcessNamespaceRenaming("NS", new List<string> {"Page1", "Page2", "Page3"},
                "NS_Renamed"));
        ...
        public void ProcessPageRenaming()
        {
            ...
            Expect.Call(aclManager.RenameResource(Actions.ForPages.ResourceMasterPrefix + "NS.Page",
                Actions.ForPages.ResourceMasterPrefix + "NS.Renamed")).Return(true);

            mocks.Replay(prov);
            mocks.Replay(aclManager);

            Collectors.SettingsProvider = prov;
            Assert.IsTrue(AuthWriter.ProcessPageRenaming("NS.Page", "NS.Renamed"),
                "ProcessPageRenaming should return true");
        ...
        public void RemoveEntriesForDirectory_Root_Group()
        {
            var mocks = new MockRepository();
            var prov = mocks.DynamicMock<ISettingsStorageProviderV30>();
            var filedProv = mocks.DynamicMock<IFilesStorageProviderV30>();
            var aclManager = mocks.DynamicMock<IAclManager>();

            Expect.Call(prov.AclManager).Return(aclManager).Repeat.Any();

            var dirName = Actions.ForDirectories.ResourceMasterPrefix + AuthTools.GetDirectoryName(filedProv, "/");
            Expect.Call(aclManager.RetrieveEntriesForSubject("G.Group")).Return(
                new[]
                {
                    ...
                    new AclEntry("D." + AuthTools.GetDirectoryName(filedProv, "/Other/"),
                        Actions.ForDirectories.UploadFiles, "G.Group", Value.Grant),
                    new AclEntry(Actions.ForGlobals.ResourceMasterPrefix, Actions.ForGlobals.ManageNavigationPaths,
                        "G.Group", Value.Grant)
                });
        ...
        public void RemoveEntriesForDirectory_Sub_Group()
        {
            ...
            var dirName = Actions.ForDirectories.ResourceMasterPrefix +
                          AuthTools.GetDirectoryName(filedProv, "/Dir/Sub/");
            Expect.Call(aclManager.RetrieveEntriesForSubject("G.Group")).Return(
                new[]
                {
                    new AclEntry(dirName, Actions.ForDirectories.List, "G.Group", Value.Grant),
                    new AclEntry(dirName, Actions.ForDirectories.UploadFiles, "G.Group", Value.Deny),
                    new AclEntry("D." + AuthTools.GetDirectoryName(filedProv, "/"), Actions.ForDirectories.UploadFiles,
                        "G.Group", Value.Grant),
                    new AclEntry(Actions.ForGlobals.ResourceMasterPrefix, Actions.ForGlobals.ManageNavigationPaths,
                        "G.Group", Value.Grant)
                });
        ...
        public void RemoveEntriesForGlobals_Group()
        {
            ...
            Expect.Call(aclManager.RetrieveEntriesForSubject("G.Group")).Return(
                new[]
                {
                    new AclEntry(Actions.ForGlobals.ResourceMasterPrefix, Actions.ForGlobals.ManageNamespaces, "G.Group",
                        Value.Grant),
                    new AclEntry(Actions.ForGlobals.ResourceMasterPrefix, Actions.ForGlobals.ManageGroups, "G.Group",
                        Value.Grant),
            ...
            Collectors.SettingsProvider = prov;
            Assert.IsTrue(AuthWriter.RemoveEntriesForGlobals(new UserGroup("Group", "Group", null)),
                "RemoveEntriesForGlobals should return true");
        ...
        public void RemoveEntriesForGlobals_User()
        {
            ...
            Expect.Call(aclManager.RetrieveEntriesForSubject("U.User")).Return(
                new[]
                {
                    new AclEntry(Actions.ForGlobals.ResourceMasterPrefix, Actions.ForGlobals.ManageNamespaces, "U.User",
                        Value.Grant),
                    new AclEntry(Actions.ForGlobals.ResourceMasterPrefix, Actions.ForGlobals.ManageGroups, "U.User",
                        Value.Grant),
            ...
            Collectors.SettingsProvider = prov;
            Assert.IsTrue(
                AuthWriter.RemoveEntriesForGlobals(new UserInfo("User", "User", "user@users.com", true, DateTime.Now,
                    null)), "RemoveEntriesForGlobals should return true");
        ...
        public void RemoveEntriesForNamespace_Group_Root()
        {
            ...
            Expect.Call(aclManager.RetrieveEntriesForSubject("G.Group")).Return(
                new[]
                {
                    ...
                    new AclEntry(Actions.ForNamespaces.ResourceMasterPrefix, Actions.ForNamespaces.ManageCategories,
                        "G.Group", Value.Grant),
                    new AclEntry(Actions.ForNamespaces.ResourceMasterPrefix + "Sub", Actions.ForNamespaces.ModifyPages,
                        "G.Group", Value.Grant),
                    new AclEntry(Actions.ForGlobals.ResourceMasterPrefix, Actions.ForGlobals.ManageNavigationPaths,
                        "G.Group", Value.Grant)
                });
            ...
            Assert.IsTrue(AuthWriter.RemoveEntriesForNamespace(new UserGroup("Group", "Group", null), null),
        ...
        public void RemoveEntriesForNamespace_Group_Sub()
        {
            ...
            Expect.Call(aclManager.RetrieveEntriesForSubject("G.Group")).Return(
                new[]
                {
                    ...
                    new AclEntry(Actions.ForNamespaces.ResourceMasterPrefix, Actions.ForNamespaces.ModifyPages,
                        "G.Group", Value.Grant),
                    new AclEntry(Actions.ForGlobals.ResourceMasterPrefix, Actions.ForGlobals.ManageNavigationPaths,
                        "G.Group", Value.Grant)
                });
            ...
            Assert.IsTrue(
                AuthWriter.RemoveEntriesForNamespace(new UserGroup("Group", "Group", null),
        ...
        public void RemoveEntriesForNamespace_User_Root()
        {
            ...
            Assert.IsTrue(
                AuthWriter.RemoveEntriesForNamespace(
        ...
        public void RemoveEntriesForNamespace_User_Sub()
        {
            ...
            Expect.Call(aclManager.RetrieveEntriesForSubject("U.User")).Return(
                new[]
                {
                    ...
                    new AclEntry(Actions.ForNamespaces.ResourceMasterPrefix, Actions.ForNamespaces.ModifyPages, "U.User",
                        Value.Grant),
                    new AclEntry(Actions.ForGlobals.ResourceMasterPrefix, Actions.ForGlobals.ManageNavigationPaths,
                        "U.User", Value.Grant)
                });
        ...
        public void RemoveEntriesForPage_Group()
        {
            ...
            Expect.Call(aclManager.RetrieveEntriesForSubject("G.Group")).Return(
                new[]
                {
                    new AclEntry(Actions.ForPages.ResourceMasterPrefix + "Page", Actions.ForPages.ManagePage, "G.Group",
                        Value.Grant),
                    new AclEntry(Actions.ForPages.ResourceMasterPrefix + "Page", Actions.ForPages.ManageCategories,
                        "G.Group", Value.Deny),
                    new AclEntry(Actions.ForPages.ResourceMasterPrefix + "Sub.Page", Actions.ForPages.ManagePage,
                        "G.Group", Value.Grant),
                    new AclEntry(Actions.ForGlobals.ResourceMasterPrefix, Actions.ForGlobals.ManageNavigationPaths,
                        "G.Group", Value.Grant)
                });
        ...
        public void RemoveEntriesForPage_User()
        {
            ...
            Expect.Call(aclManager.RetrieveEntriesForSubject("U.User")).Return(
                new[]
                {
                    new AclEntry(Actions.ForPages.ResourceMasterPrefix + "Page", Actions.ForPages.ManagePage, "U.User",
                        Value.Grant),
                    new AclEntry(Actions.ForPages.ResourceMasterPrefix + "Page", Actions.ForPages.ManageCategories,
                        "U.User", Value.Deny),
                    new AclEntry(Actions.ForPages.ResourceMasterPrefix + "Sub.Page", Actions.ForPages.ManagePage,
            ...
            Assert.IsTrue(
                AuthWriter.RemoveEntriesForPage(
                    new UserInfo("User", "User", "user@users.com", true, DateTime.Now, null),
                    new PageInfo("Page", null, DateTime.Now)), "RemoveEntriesForPage should return true");
        ...
        public void SetPermissionForDirectory_Group_Delete()
        {
            ...
            Expect.Call(
                aclManager.DeleteEntry(
                    Actions.ForDirectories.ResourceMasterPrefix + AuthTools.GetDirectoryName(filesProv, "/Sub/"),
            ...
            Collectors.SettingsProvider = prov;
            Assert.IsTrue(
                AuthWriter.SetPermissionForDirectory(AuthStatus.Delete, filesProv, "/Sub/", Actions.ForDirectories.List,
        ...
        public void SetPermissionForDirectory_Group_Deny()
        {
            ...
            Collectors.SettingsProvider = prov;
            Assert.IsTrue(
                AuthWriter.SetPermissionForDirectory(AuthStatus.Deny, filesProv, "/",
                    Actions.ForDirectories.CreateDirectories,
                    new UserGroup("Group", "Group", null)), "SetPermissionForDirectory should return true");
        ...
        public void SetPermissionForDirectory_Group_Grant()
        {
            ...
            Collectors.SettingsProvider = prov;
            Assert.IsTrue(
                AuthWriter.SetPermissionForDirectory(AuthStatus.Grant, filesProv, "/",
                    Actions.ForDirectories.DownloadFiles,
                    new UserGroup("Group", "Group", null)), "SetPermissionForDirectory should return true");
        ...
        public void SetPermissionForNamespace_User_Deny()
        {
            ...
            Collectors.SettingsProvider = prov;
            Assert.IsTrue(AuthWriter.SetPermissionForNamespace(AuthStatus.Deny, null,
                Actions.ForNamespaces.ModifyPages,
                new UserInfo("User", "User", "user@users.com", true, DateTime.Now, null)),
                "SetPermissionForNamespace should return true");
        ...
        public void SetPermissionForNamespace_User_Grant()
        {
            ...
            Collectors.SettingsProvider = prov;
            Assert.IsTrue(AuthWriter.SetPermissionForNamespace(AuthStatus.Grant, null,
                Actions.ForNamespaces.CreatePages,
                new UserInfo("User", "User", "user@users.com", true, DateTime.Now, null)),
                "SetPermissionForNamespace should return true");
        ...
        public void SetPermissionForPage_Group_Delete()
        {
            ...
            Collectors.SettingsProvider = prov;
            Assert.IsTrue(
                AuthWriter.SetPermissionForPage(AuthStatus.Delete, new PageInfo("NS.Page", null, DateTime.Now),
                    Actions.ForPages.UploadAttachments, new UserGroup("Group", "Group", null)),
        ...
        public void SetPermissionForPage_Group_Deny()
        {
            ...
            Assert.IsTrue(AuthWriter.SetPermissionForPage(AuthStatus.Deny, new PageInfo("Page", null, DateTime.Now),
                Actions.ForPages.ManageCategories, new UserGroup("Group", "Group", null)),
                "SetPermissionForPage should return true");
        ...
        public void SetPermissionForPage_Group_Grant()
        {
            ...
            Assert.IsTrue(AuthWriter.SetPermissionForPage(AuthStatus.Grant, new PageInfo("Page", null, DateTime.Now),
                Actions.ForPages.ModifyPage, new UserGroup("Group", "Group", null)),
                "SetPermissionForPage should return true");
        ...
        public void SetPermissionForPage_User_Delete()
        {
            ...
            Assert.IsTrue(
                AuthWriter.SetPermissionForPage(AuthStatus.Delete, new PageInfo("NS.Page", null, DateTime.Now),
                    Actions.ForPages.UploadAttachments,
                    new UserInfo("User", "User", "user@users.com", true, DateTime.Now, null)),
                "SetPermissionForPage should return true");
        ...
        public void SetPermissionForPage_User_Deny()
        {
            ...
            Collectors.SettingsProvider = prov;
            Assert.IsTrue(AuthWriter.SetPermissionForPage(AuthStatus.Deny, new PageInfo("Page", null, DateTime.Now),
                Actions.ForPages.ManageCategories,
                new UserInfo("User", "User", "user@users.com", true, DateTime.Now, null)),
                "SetPermissionForPage should return true");
