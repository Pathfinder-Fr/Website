...
namespace ScrewTurn.Wiki.SearchEngine
{
    ...
    public class Word
    {
        ...
        /// </summary>
        /// <remarks>
        ///     Computing the result is <b>O(n)</b>, where <b>n</b> is the number of
        ...
        /// <remarks>
        ///     If <b>positions</b> is empty, the effect of the invocation of the method is equal to
        ///     that of <see cref="RemoveOccurrences" /> with the same <b>document</b>.
        ///     Bulk-adding the occurrences is <b>O(1)</b>.
        /// </remarks>
        /// <exception cref="ArgumentNullException">
        ///     If <paramref name="document" /> or <paramref name="positions" /> are
        ///     <c>null</c>.
        /// </exception>
