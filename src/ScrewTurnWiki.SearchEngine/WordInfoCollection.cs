...
namespace ScrewTurn.Wiki.SearchEngine
{
    ...
    public class WordInfoCollection : ICollection<WordInfo>
    {
            ...
            get
            {
                if (index < 0 || index > items.Count - 1)
                    throw new IndexOutOfRangeException(
                        "Index should be greater than or equal to zero and less than the number of items in the collection");
        ...
        ///     If <paramref name="arrayIndex" /> is not within the bounds of
        ///     <paramref name="array" />.
        /// </exception>
        public void CopyTo(WordInfo[] array, int arrayIndex)
        {
            ...
            if (arrayIndex < 0 || arrayIndex > array.Length - 1)
                throw new ArgumentOutOfRangeException("arrayIndex",
                    "Index should be greater than or equal to zero and less than the number of items in the array");

            if (array.Length - arrayIndex < items.Count)
                throw new ArgumentOutOfRangeException("arrayIndex",
                    "Not enough space for copying the items starting at the specified index");
