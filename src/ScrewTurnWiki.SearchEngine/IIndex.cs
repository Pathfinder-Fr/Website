...
{
    /// <summary>
    ///     A delegate that is used for converting a <see cref="DumpedDocument" /> to an instance of a class implementing
    ///     <see cref="IDocument" />,
    ...
    public interface IIndex
    {
        ...
        int StoreDocument(IDocument document, IList<string> keywords, string content, object state);
