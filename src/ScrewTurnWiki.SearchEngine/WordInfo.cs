...
namespace ScrewTurn.Wiki.SearchEngine
{
    ...
    public class WordInfo : BasicWordInfo, IEquatable<WordInfo>, IComparable<WordInfo>
    {
        ...
        /// <remarks>
        ///     <b>The First Char Index does not partecipate to the comparison.</b>
        /// </remarks>
        public int CompareTo(WordInfo other)
        {
            ...
            var res = location.CompareTo(other.Location)*2;
            var res2 = wordIndex.CompareTo(other.WordIndex)*3;
        ...
        public static bool operator ==(WordInfo x, WordInfo y)
        {
            if (ReferenceEquals(x, null) && !ReferenceEquals(y, null) ||
                !ReferenceEquals(x, null) && ReferenceEquals(y, null)) return false;
