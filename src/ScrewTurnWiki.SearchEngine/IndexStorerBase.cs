...
namespace ScrewTurn.Wiki.SearchEngine
{
    ...
    public abstract class IndexStorerBase : IDisposable
    {
        ...
        /// </summary>
        protected Exception reasonForDataCorruption;
        ...
        public IndexStorerBase(IInMemoryIndex index)
        {
            ...
            this.index = index;
            indexChangedHandler = IndexChangedHandler;
        ...
        protected abstract void LoadIndexInternal(out DumpedDocument[] documents, out DumpedWord[] words,
            out DumpedWordMapping[] mappings);
            ...
            lock (this)
            {
                ...
                switch (e.Change)
                {
                    ...
                    case IndexChangeType.DocumentAdded:
                        if (!dataCorrupted)
                        {
                            var result = SaveData(e.ChangeData, e.State);
                            e.Result = result;
                        }
                        break;
