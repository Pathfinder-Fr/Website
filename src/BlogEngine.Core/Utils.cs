namespace BlogEngine.Core
{
    ...
    public static class Utils
    {
        ...
        public static IEnumerable<Assembly> CodeAssemblies()
        {
            ...
            var appAssembly = HttpContext.Current.ApplicationInstance.GetType().Assembly;
            codeAssemblies.Add(appAssembly);

            appAssembly = HttpContext.Current.ApplicationInstance.GetType().BaseType.Assembly;
            codeAssemblies.Add(appAssembly);

            var appAssembly2 = System.Web.Compilation.BuildManager.GetGlobalAsaxType().BaseType.Assembly;
            if (appAssembly != appAssembly2)
            {
                codeAssemblies.Add(appAssembly2);
            }
