namespace BlogEngine.Core
{
    ...
    public class BlogSettings
    {
        ...
        public string AdministratorRole
        {
            get
            {
                return ConfigurationManager.AppSettings["BlogEngine.AdminRole"] ?? "blogadministrator";
            }
        }
        ...
        public string Theme
        {
            get
            {
                ...
                // Sueetie Modified - Return Sueetie Mobile Theme, not BE.NET Mobile Theme
                if (Utils.IsMobile && !string.IsNullOrEmpty(this.MobileTheme))
                {
                    return SueetieContext.Current.Theme;
