...
namespace ScrewTurn.Wiki.PluginFramework
{
    ...
    public interface IUsersStorageProviderV30 : IProviderV30
    {
        ...
        /// </exception>
        UserInfo AddUser(string username, string displayName, string password, string email, bool active,
            DateTime dateTime);
        ...
        /// <returns>The correct <see cref="T:UserGroup" /> object or <c>null</c>.</returns>
        /// <exception cref="ArgumentNullException">
        ///     If <paramref name="group" /> or <paramref name="description" /> are <c>null</c>
        ///     .
        /// </exception>
        ...
        UserInfo SetUserMembership(UserInfo user, IEnumerable<string> groups);
        ...
        /// <exception cref="ArgumentNullException">
        ///     If <paramref name="username" /> or <paramref name="password" /> are <c>null</c>
        ///     .
        /// </exception>
