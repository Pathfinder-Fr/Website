...
namespace ScrewTurn.Wiki.PluginFramework
{
    ...
    /// </summary>
    /// <remarks>
    ///     A class that implements this interface <b>should not</b> have any kind of data caching.
    ...
    public interface IFilesStorageProviderV30 : IStorageProviderV30
    {
        ...
        /// <exception cref="ArgumentException">If <paramref name="directory" /> does not exist.</exception>
        IEnumerable<string> ListDirectories(string directory);
        ...
        ///     does not support writing, or if <paramref name="fullName" /> does not exist.
        /// </exception>
        ...
        IEnumerable<string> GetPagesWithAttachments();
        ...
        IList<string> ListPageAttachments(PageInfo pageInfo);
