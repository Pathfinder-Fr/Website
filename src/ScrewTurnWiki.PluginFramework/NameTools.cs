...
namespace ScrewTurn.Wiki.PluginFramework
{
    ...
    public static class NameTools
    {
        ...
        {
            return AreNamespaceEquals(ns1 != null ? ns1.Name : null, ns2);
        }

        /// <summary />
        public static bool AreNamespaceEquals(string ns1, NamespaceInfo ns2)
        {
            return AreNamespaceEquals(ns1, ns2 != null ? ns2.Name : null);
        }

        /// <summary />
        public static bool AreNamespaceEquals(NamespaceInfo ns1, NamespaceInfo ns2)
        {
            return AreNamespaceEquals(ns1 != null ? ns1.Name : null, ns2 != null ? ns2.Name : null);
        }
