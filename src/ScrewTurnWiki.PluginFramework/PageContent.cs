...
namespace ScrewTurn.Wiki.PluginFramework
{
    ...
    public class PageContent
    {
        ...
        /// </summary>
        protected IList<string> keywords;
        ...
        /// </summary>
        protected IList<string> linkedPages = new string[0];
        ...
        public PageContent(PageInfo pageInfo, string title, string user, DateTime lastModified, string comment,
            string content,
            IList<string> keywords, string description)
        {
        ...
        /// </summary>
        public IList<string> LinkedPages
        {
