...
{
    /// <summary>
    ///     The base interface that all the Providers must implement. All the Provider Type-specific interfaces inherit from
    ///     this one or from a one, either directly or from a derived interface.
    /// </summary>
