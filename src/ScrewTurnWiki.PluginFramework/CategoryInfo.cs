...
{
    /// <summary>
    ///     Represents a Page Category. A page can be binded with one or more categories (within the same Provider); this class
    ///     manages this binding.
    /// </summary>
    public class CategoryInfo
    {
        ...
        /// </summary>
        protected IList<string> pages = new List<string>();
