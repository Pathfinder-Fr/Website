...
{
    /// <summary>
    ///     The interface that must be implemented in order to create a custom Settings and Log Storage Provider for ScrewTurn
    ///     Wiki.
    /// </summary>
    /// <remarks>
    ///     A class that implements this interface <b>should</b> have some kind of data caching.
    ///     The Provider <b>should not</b> use the method <see cref="M:IHost.GetSettingValue" /> during the execution of
    ///     the <see cref="M:ISettingsStorageProvider.Init" /> method, nor access the wiki log.
    /// </remarks>
    public interface ISettingsStorageProviderV30 : IProviderV30
    {
        ...
        /// <summary />
        string[] GetIncomingLinks(string page);
        ...
        /// <returns>The content.</returns>
        string GetMetaDataItem(MetaDataItem item, string tag, bool nullTagIfMissing);
        ...
        List<RecentChange> GetRecentChanges();
        ...
        ///     If <paramref name="page" />, <paramref name="title" /> or
        ///     <paramref name="user" /> are <c>null</c>.
        /// </exception>
        /// <exception cref="ArgumentException">
        ///     If <paramref name="page" />, <paramref name="title" /> or <paramref name="user" />
        ///     are empty.
        /// </exception>
        bool AddRecentChange(string page, string title, string messageSubject, DateTime dateTime, string user,
        ...
        /// <exception cref="ArgumentNullException">
        ///     If <paramref name="filename" /> or <paramref name="assembly" /> are <c>null</c>
        ///     .
        /// </exception>
        ...
        /// <exception cref="ArgumentNullException">
        ///     If <paramref name="page" /> or <paramref name="outgoingLinks" /> are
        ///     <c>null</c>.
        /// </exception>
