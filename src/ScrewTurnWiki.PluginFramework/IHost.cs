...
namespace ScrewTurn.Wiki.PluginFramework
{
    ...
    public interface IHostV30
    {
        ...
        /// <remarks>
        ///     If the built-it <i>admin</i> user is authenticated, the returned user
        ///     has <i>admin</i> as Username.
        /// </remarks>
        ...
        ///     If <paramref name="page" />, <paramref name="action" /> or
        ///     <paramref name="user" /> are <c>null</c>.
        /// </exception>
        /// <exception cref="ArgumentException">If <paramref name="action" /> is empty.</exception>
        ...
        /// <returns><c>true</c> if the action is allowed, <c>false</c> otherwise.</returns>
        /// <exception cref="ArgumentNullException">
        ///     If <paramref name="directory" />, <paramref name="action" /> or
        ///     <paramref name="user" /> are <c>null</c>.
        /// </exception>
        /// <exception cref="ArgumentException">If <paramref name="action" /> is empty.</exception>
        ...
        IList<CategoryInfo> GetCategoriesPerPage(PageInfo page);
        ...
        /// <summary>
        ///     Prepares content for indexing in the search engine, performing bare-bones formatting and removing all WikiMarkup
        ///     and XML-like characters.
        /// </summary>
        ...
        SearchResultCollection PerformSearch(string query, bool fullText, bool filesAndAttachments,
        ...
        /// <exception cref="ArgumentNullException">
        ///     If <paramref name="recipient" />, <paramref name="sender" />,
        ///     <paramref name="subject" /> or <paramref name="body" /> are <c>null</c>.
        /// </exception>
        /// <exception cref="ArgumentException">
        ///     If <paramref name="recipient" />, <paramref name="sender" />,
        ///     <paramref name="subject" /> or <paramref name="body" /> are empty.
        /// </exception>
        ...
        /// <param name="value">
        ///     The value of the item, placed in the content: if <b>item</b> is <b>ToolbarItem.SpecialTagWrap</b>,
        ///     separate start and end tag with a pipe.
        /// </param>
        /// <exception cref="ArgumentNullException">If <paramref name="text" /> or <paramref name="value" /> are <c>null</c>.</exception>
        /// <exception cref="ArgumentException">
        ///     If <paramref name="text" /> or <paramref name="value" /> are empty, or if they contain single or double quotes,
        ///     or if <paramref name="value" /> does not contain a pipe when <paramref name="item" /> is <b>SpecialTagWrap</b>.
        /// </exception>
        ...
        ///     <see cref="T:IFormatterProviderV30" />).
        /// </param>
        ...
        IEnumerable<IPagesStorageProviderV30> GetPagesStorageProviders(bool enabled);
        ...
        /// <param name="enabled"><c>true</c> to get enabled providers, <c>false</c> to get disabled providers.</param>
        /// <returns>The providers.</returns>
        IEnumerable<IUsersStorageProviderV30> GetUsersStorageProviders(bool enabled);
        ...
        /// <param name="enabled"><c>true</c> to get enabled providers, <c>false</c> to get disabled providers.</param>
        /// <returns>The providers.</returns>
        IEnumerable<IFilesStorageProviderV30> GetFilesStorageProviders(bool enabled);
        ...
        /// <param name="enabled"><c>true</c> to get enabled providers, <c>false</c> to get disabled providers.</param>
        /// <returns>The providers.</returns>
        IEnumerable<ICacheProviderV30> GetCacheProviders(bool enabled);
        ...
        /// <param name="enabled"><c>true</c> to get enabled providers, <c>false</c> to get disabled providers.</param>
        /// <returns>The providers.</returns>
        IEnumerable<IFormatterProviderV30> GetFormatterProviders(bool enabled);
        ...
        /// <returns><c>true</c> if the operation succeeded, <c>false</c> otherwise.</returns>
        /// <exception cref="ArgumentNullException">
        ///     If <paramref name="administrators" /> or <paramref name="users" /> are
        ///     <c>null</c>.
        /// </exception>
    ...
    public enum SettingName
    {
        ...
        /// <summary>
        ///     The default Time Zone (a string representing the shift in <b>minutes</b> respect to the Greenwich time, for example
        ///     <b>-120</b>).
        /// </summary>
        DefaultTimeZone,
