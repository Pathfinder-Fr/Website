...
namespace ScrewTurn.Wiki.PluginFramework
{
    ...
    public interface IPagesStorageProviderV30 : IStorageProviderV30
    {
        ...
        IList<CategoryInfo> GetCategories(NamespaceInfo nspace);
        ...
        /// <exception cref="ArgumentNullException">If <paramref name="page" /> is <c>null</c>.</exception>
        IList<CategoryInfo> GetCategoriesForPage(PageInfo page);
        ...
        IList<PageInfo> GetPages(NamespaceInfo nspace);

        /// <summary>
        ///     Find all pages matching the requested filter.
        /// </summary>
        IList<PageInfo> FindPages(FindPagesFilter filter);
        ...
        IList<PageInfo> GetUncategorizedPages(NamespaceInfo nspace);
        ...
        /// <summary>
        /// Gets the cache of the content of a page.
        /// </summary>
        PageContentCache GetContentCache(PageInfo pageInfo);

        /// <summary/>
        void SetContentCache(PageInfo pageInfo, string formattedContent, IEnumerable<string> linkedPages);

        /// <summary/>
        void RemoveContentCache(PageInfo pageInfo);
        ...
        /// <exception cref="ArgumentNullException">If <paramref name="page" /> is <c>null</c>.</exception>
        IList<Message> GetMessages(PageInfo page);
        ...
        bool BulkStoreMessages(PageInfo page, IList<Message> messages);
        ...
        IList<NavigationPath> GetNavigationPaths(NamespaceInfo nspace);
        ...
        /// <returns></returns>
        IList<PageInfoWithTitle> GetPagesInfoWithTitleFromCategories(string nspace, string category, int pageIndex, int pageSize);
    }
